...
If you find any discrepancies in our Documentation or you any awesome suggestions for us, report it to us by opening a new issue using the  [Documentation template](https://github.com/cohesity/cohesity-powershell-module/issues/new?assignees=&labels=&template=documentation.md&title=) provided in our GitHub repo.
...
Reach out to us [here](https://github.com/cohesity/cohesity-powershell-module/issues/new?assignees=&labels=&template=sample-requests---questions---.md&title=) if you have any questions or if you want to request more examples and sample code. We would love to help you out!!
...
You can file new issues [here](https://github.com/cohesity/cohesity-powershell-module/issues/new?assignees=&labels=&template=bug-report.md&title=).
