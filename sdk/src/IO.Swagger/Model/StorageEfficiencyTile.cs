...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StorageEfficiencyTile :  IEquatable<StorageEfficiencyTile>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  LastWeekDataInBytes: ").Append(LastWeekDataInBytes).Append("\n");
            sb.Append("  LastWeekDataInDedupedBytes: ").Append(LastWeekDataInDedupedBytes).Append("\n");
            sb.Append("  LastWeekDataReduction: ").Append(LastWeekDataReduction).Append("\n");
            sb.Append("  LastWeekLogicalUsedBytes: ").Append(LastWeekLogicalUsedBytes).Append("\n");
            sb.Append("  LastWeekPhysicalUsedBytes: ").Append(LastWeekPhysicalUsedBytes).Append("\n");
            sb.Append("  LastWeekStorageEfficiency: ").Append(LastWeekStorageEfficiency).Append("\n");
