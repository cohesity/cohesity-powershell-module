...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ThroughputTile :  IEquatable<ThroughputTile>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  LastDayPeakReadBytesPerSec: ").Append(LastDayPeakReadBytesPerSec).Append("\n");
            sb.Append("  LastDayPeakWriteBytesPerSec: ").Append(LastDayPeakWriteBytesPerSec).Append("\n");
            sb.Append("  LastDayReadBytesPerSec: ").Append(LastDayReadBytesPerSec).Append("\n");
            sb.Append("  LastDayWriteBytesPerSec: ").Append(LastDayWriteBytesPerSec).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
