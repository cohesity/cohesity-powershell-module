...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IopsTile :  IEquatable<IopsTile>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  LastDayPeakReadIosPerSec: ").Append(LastDayPeakReadIosPerSec).Append("\n");
            sb.Append("  LastDayPeakWriteIosPerSec: ").Append(LastDayPeakWriteIosPerSec).Append("\n");
            sb.Append("  LastDayReadIosPerSec: ").Append(LastDayReadIosPerSec).Append("\n");
            sb.Append("  LastDayWriteIosPerSec: ").Append(LastDayWriteIosPerSec).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
