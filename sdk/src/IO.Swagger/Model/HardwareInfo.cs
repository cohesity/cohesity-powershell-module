...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HardwareInfo :  IEquatable<HardwareInfo>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PrimaryBondName: ").Append(PrimaryBondName).Append("\n");
            sb.Append("  ProductModel: ").Append(ProductModel).Append("\n");
            sb.Append("  SecondaryBondName: ").Append(SecondaryBondName).Append("\n");
