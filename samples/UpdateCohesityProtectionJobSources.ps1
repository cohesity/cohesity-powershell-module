...
#>
function Update-CohesityProtectionJobSources {
    ...
    process {
        $protectionJob = Get-CohesityProtectionJob -ID $ID
        ...
        $filteredProtectionSources = get-Nodes $protectionSources $Names
        ...
        Set-CohesityProtectionJob -ID $ID -ProtectionJob $protectionJob
    }
