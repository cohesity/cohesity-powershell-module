...
namespace Cohesity.Models
{
    ...
    public partial class ThrottlingPolicy :  IEquatable<ThrottlingPolicy>
    {
        ...
        public ThrottlingPolicy(bool? enforceMaxStreams = default(bool?), bool? isEnabled = default(bool?), LatencyThresholds latencyThresholds = default(LatencyThresholds), int? maxConcurrentStreams = default(int?))
        {
