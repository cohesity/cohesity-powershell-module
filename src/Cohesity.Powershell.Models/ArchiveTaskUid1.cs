...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ArchiveTaskUid1 :  IEquatable<ArchiveTaskUid1>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchiveTaskUid1" /> class.
        /// </summary>
        ...
        public ArchiveTaskUid1(long? clusterId = default(long?), long? clusterIncarnationId = default(long?), long? id = default(long?))
        {
        ...
        {
            return this.Equals(input as ArchiveTaskUid1);
        }

        /// <summary>
        /// Returns true if ArchiveTaskUid1 instances are equal
        /// </summary>
        /// <param name="input">Instance of ArchiveTaskUid1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArchiveTaskUid1 input)
        {
            if (input == null)
                return false;
