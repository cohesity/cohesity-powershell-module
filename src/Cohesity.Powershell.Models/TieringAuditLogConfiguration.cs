...
namespace Cohesity.Model
{
    ...
    public partial class TieringAuditLogConfiguration :  IEquatable<TieringAuditLogConfiguration>
    {
        ...
        public TieringAuditLogConfiguration(bool? enabled = default(bool?), int? retentionPeriodDays = default(int?))
        {
            ...
            if (enabled == null)
            {
                throw new InvalidDataException("enabled is a required property for TieringAuditLogConfiguration and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("retentionPeriodDays is a required property for TieringAuditLogConfiguration and cannot be null");
            }
            else
            {
