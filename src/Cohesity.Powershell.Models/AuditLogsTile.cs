...
namespace Cohesity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuditLogsTile :  IEquatable<AuditLogsTile>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditLogsTile" /> class.
        /// </summary>
        ...
        public AuditLogsTile(List<ClusterAuditLog> clusterAuditLogs = default(List<ClusterAuditLog>), long? totalCount = default(long?))
        {
        ...
        {
            return this.Equals(input as AuditLogsTile);
        }

        /// <summary>
        /// Returns true if AuditLogsTile instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditLogsTile to be compared</param>
        /// <returns>Boolean</returns>
