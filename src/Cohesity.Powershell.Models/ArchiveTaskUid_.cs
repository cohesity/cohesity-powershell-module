...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ArchiveTaskUid_ :  IEquatable<ArchiveTaskUid_>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchiveTaskUid_" /> class.
        /// </summary>
        ...
        public ArchiveTaskUid_(long? clusterId = default(long?), long? clusterIncarnationId = default(long?), long? id = default(long?))
        {
        ...
        {
            return this.Equals(input as ArchiveTaskUid_);
        }

        /// <summary>
        /// Returns true if ArchiveTaskUid_ instances are equal
        /// </summary>
        /// <param name="input">Instance of ArchiveTaskUid_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArchiveTaskUid_ input)
        {
            if (input == null)
                return false;
