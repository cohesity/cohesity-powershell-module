...
namespace Cohesity.Model
{
    ...
    public partial class OutlookMailbox :  IEquatable<OutlookMailbox>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OutlookMailbox {\n");
            sb.Append("  MailboxObject: ").Append(MailboxObject).Append("\n");
            sb.Append("  OutlookFolderList: ").Append(OutlookFolderList).Append("\n");
            sb.Append("  RestoreEntireMailbox: ").Append(RestoreEntireMailbox).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
