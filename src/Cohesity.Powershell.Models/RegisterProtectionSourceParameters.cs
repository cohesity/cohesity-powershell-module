...
namespace Cohesity.Model
{
    ...
    public partial class RegisterProtectionSourceParameters :  IEquatable<RegisterProtectionSourceParameters>
    {
        ...
        /// </summary>
        /// <value>Specifies the entity type if the environment is kAcropolis. overrideDescription: true</value>
        [DataMember(Name="acropolisType", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>Specifies the entity type if the environment is kHyperV. overrideDescription: true</value>
        [DataMember(Name="hyperVType", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>Specifies the entity type if the environment is kKubernetes. overrideDescription: true</value>
        [DataMember(Name="kubernetesType", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>Specifies the entity type if the environment is kKVM. overrideDescription: true</value>
        [DataMember(Name="kvmType", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>Specifies the entity type such as &#39;kStorageArray&#39; if the environment is kNimble. overrideDescription: true</value>
        [DataMember(Name="nimbleType", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>Specifies the entity type such as &#39;kDomain&#39;, &#39;kOutlook&#39;, &#39;kMailbox&#39;, if the environment is kO365.</value>
        [DataMember(Name="office365Type", EmitDefaultValue=false)]
        ...
        public RegisterProtectionSourceParameters(AcropolisTypeEnum? acropolisType = default(AcropolisTypeEnum?), string agentEndpoint = default(string), List<string> allowedIpAddresses = default(List<string>), AwsCredentials awsCredentials = default(AwsCredentials), AWSFleetParams awsFleetParams = default(AWSFleetParams), AzureCredentials azureCredentials = default(AzureCredentials), List<string> blacklistedIpAddresses = default(List<string>), FleetNetworkParams clusterNetworkInfo = default(FleetNetworkParams), List<string> deniedIpAddresses = default(List<string>), string encryptionKey = default(string), string endpoint = default(string), EnvironmentEnum? environment = default(EnvironmentEnum?), ExchangeDAGProtectionPreference exchangeDagProtectionPreference = default(ExchangeDAGProtectionPreference), bool? forceRegister = default(bool?), GcpCredentials gcpCredentials = default(GcpCredentials), HostTypeEnum? hostType = default(HostTypeEnum?), HyperVTypeEnum? hyperVType = default(HyperVTypeEnum?), bool? isInternalEncrypted = default(bool?), bool? isProxyHost = default(bool?), RegisteredProtectionSourceIsilonParams isilonParams = default(RegisteredProtectionSourceIsilonParams), KubernetesCredentials kubernetesCredentials = default(KubernetesCredentials), KubernetesTypeEnum? kubernetesType = default(KubernetesTypeEnum?), KvmTypeEnum? kvmType = default(KvmTypeEnum?), NasMountCredentialParams nasMountCredentials = default(NasMountCredentialParams), NetappTypeEnum? netappType = default(NetappTypeEnum?), NimbleTypeEnum? nimbleType = default(NimbleTypeEnum?), List<Office365Credentials> office365CredentialsList = default(List<Office365Credentials>), string office365Region = default(string), Office365TypeEnum? office365Type = default(Office365TypeEnum?), string password = default(string), PhysicalParams physicalParams = default(PhysicalParams), PhysicalTypeEnum? physicalType = default(PhysicalTypeEnum?), List<long?> proxyHostSourceIdList = default(List<long?>), PureTypeEnum? pureType = default(PureTypeEnum?), bool? sourceSideDedupEnabled = default(bool?), SslVerification sslVerification = default(SslVerification), List<Subnet> subnets = default(List<Subnet>), ThrottlingPolicyParameters throttlingPolicy = default(ThrottlingPolicyParameters), List<ThrottlingPolicyOverride> throttlingPolicyOverrides = default(List<ThrottlingPolicyOverride>), bool? useOAuthForExchangeOnline = default(bool?), string username = default(string), VlanParameters vlanParams = default(VlanParameters), VmwareParams vmwareParams = default(VmwareParams), VmwareTypeEnum? vmwareType = default(VmwareTypeEnum?))
        {
        ...
        [DataMember(Name="isInternalEncrypted", EmitDefaultValue=false)]
