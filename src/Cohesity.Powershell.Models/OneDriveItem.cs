...
namespace Cohesity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OneDriveItem :  IEquatable<OneDriveItem>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneDriveItem" /> class.
        /// </summary>
        ...
        public OneDriveItem(bool? isFileItem = default(bool?), string itemId = default(string), string itemPath = default(string))
        {
        ...
        {
            return this.Equals(input as OneDriveItem);
        }

        /// <summary>
        /// Returns true if OneDriveItem instances are equal
        /// </summary>
        /// <param name="input">Instance of OneDriveItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OneDriveItem input)
        {
            if (input == null)
                return false;
