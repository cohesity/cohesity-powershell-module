...
namespace Cohesity.Model
{
    ...
    public partial class S3ViewBackupProperties :  IEquatable<S3ViewBackupProperties>
    {
        ...
        public S3ViewBackupProperties(string accessKey = default(string), S3BucketConfigProto s3Config = default(S3BucketConfigProto), string secretKey = default(string))
        {
