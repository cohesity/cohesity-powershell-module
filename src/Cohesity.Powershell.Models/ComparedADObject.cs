...
namespace Cohesity.Model
{
    ...
    public partial class ComparedADObject :  IEquatable<ComparedADObject>
    {
        ...
        /// <summary>
        /// Specifies the flags related to this AD Object. &#39;kEqual&#39; indicates all the attributes of the AD Object on the Snapshot and Production are equal. &#39;kNotEqual&#39; indicates atleast one of the attribute of the AD Object on the Snapshot and Production AD are not equal. &#39;kRestorePasswordRequired&#39; indicates the AD Object is of &#39;User&#39; object class type. when restoring this object from Snapshot AD to Priduction AD, a password is required. &#39;kMovedOnDestination&#39; indicates the the object has moved to another container or OU in production AD compared to AD snapshot. In this case, the distinguishedName will be different for these objects &#39;kDestinationNotFound&#39; indicates the object corresponding to dest_guid specified is missing from Production AD. Caller should check this flag and empty &#39;dest_guid&#39; first to find out destination is missing. &#39;kDisableSupported&#39; indicates the enable and disable is supported on the AD Object. AD Objects of type &#39;User&#39; and &#39;Computers&#39; support this operation.
        /// </summary>
        /// <value>Specifies the flags related to this AD Object. &#39;kEqual&#39; indicates all the attributes of the AD Object on the Snapshot and Production are equal. &#39;kNotEqual&#39; indicates atleast one of the attribute of the AD Object on the Snapshot and Production AD are not equal. &#39;kRestorePasswordRequired&#39; indicates the AD Object is of &#39;User&#39; object class type. when restoring this object from Snapshot AD to Priduction AD, a password is required. &#39;kMovedOnDestination&#39; indicates the the object has moved to another container or OU in production AD compared to AD snapshot. In this case, the distinguishedName will be different for these objects &#39;kDestinationNotFound&#39; indicates the object corresponding to dest_guid specified is missing from Production AD. Caller should check this flag and empty &#39;dest_guid&#39; first to find out destination is missing. &#39;kDisableSupported&#39; indicates the enable and disable is supported on the AD Object. AD Objects of type &#39;User&#39; and &#39;Computers&#39; support this operation.</value>
