...
namespace Cohesity.Model
{
    ...
    public partial class CreateIdpConfigurationRequest :  IEquatable<CreateIdpConfigurationRequest>
    {
        ...
        public CreateIdpConfigurationRequest(bool? allowLocalAuthentication = default(bool?), string certificate = default(string), string certificateFilename = default(string), string domain = default(string), bool? enable = default(bool?), string issuerId = default(string), string name = default(string), List<string> roles = default(List<string>), string samlAttributeName = default(string), bool? signRequest = default(bool?), string ssoUrl = default(string), string tenantId = default(string))
        {
