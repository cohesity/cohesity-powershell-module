...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class UniqueGlobalId9 :  IEquatable<UniqueGlobalId9>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniqueGlobalId9" /> class.
        /// </summary>
        ...
        public UniqueGlobalId9(long? clusterId = default(long?), long? clusterIncarnationId = default(long?), long? id = default(long?))
        {
        ...
        {
            return this.Equals(input as UniqueGlobalId9);
        }

        /// <summary>
        /// Returns true if UniqueGlobalId9 instances are equal
        /// </summary>
        /// <param name="input">Instance of UniqueGlobalId9 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniqueGlobalId9 input)
        {
            if (input == null)
                return false;
