...
namespace Cohesity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HBaseRecoverJobParams :  IEquatable<HBaseRecoverJobParams>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HBaseRecoverJobParams" /> class.
        /// </summary>
        ...
        public HBaseRecoverJobParams(HdfsConnectParams hdfsConnectParams = default(HdfsConnectParams), string suffix = default(string))
        {
        ...
        {
            return this.Equals(input as HBaseRecoverJobParams);
        }

        /// <summary>
        /// Returns true if HBaseRecoverJobParams instances are equal
        /// </summary>
        /// <param name="input">Instance of HBaseRecoverJobParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HBaseRecoverJobParams input)
        {
            if (input == null)
                return false;
