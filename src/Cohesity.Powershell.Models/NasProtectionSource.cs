...
namespace Cohesity.Models
{
    ...
    public partial class NasProtectionSource :  IEquatable<NasProtectionSource>
    {
        ...
        public NasProtectionSource(string description = default(string), string mountPath = default(string), string name = default(string), ProtocolEnum? protocol = default(ProtocolEnum?), TypeEnum? type = default(TypeEnum?))
        {
