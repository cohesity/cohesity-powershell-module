...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ViewProtectionSource_ :  IEquatable<ViewProtectionSource_>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewProtectionSource_" /> class.
        /// </summary>
        ...
        public ViewProtectionSource_(UniqueGlobalId7 id = default(UniqueGlobalId7), string name = default(string), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
            this.Name = name;
            this.Type = type;
        ...
        {
            return this.Equals(input as ViewProtectionSource_);
        }

        /// <summary>
        /// Returns true if ViewProtectionSource_ instances are equal
        /// </summary>
        /// <param name="input">Instance of ViewProtectionSource_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ViewProtectionSource_ input)
        {
            if (input == null)
                return false;
