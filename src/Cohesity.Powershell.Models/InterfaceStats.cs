...
namespace Cohesity.Model
{
    ...
    public partial class InterfaceStats :  IEquatable<InterfaceStats>
    {
        ...
        /// </summary>
        [DataMember(Name="rxBytes", EmitDefaultValue=true)]
        public long? RxBytes { get; set; }

        /// <summary>
        /// Gets or Sets RxDropped
        /// </summary>
        [DataMember(Name="rxDropped", EmitDefaultValue=true)]
        public long? RxDropped { get; set; }

        /// <summary>
        /// Gets or Sets RxErrors
        /// </summary>
        [DataMember(Name="rxErrors", EmitDefaultValue=true)]
        ...
        [DataMember(Name="rxPkts", EmitDefaultValue=true)]
        public long? RxPkts { get; set; }

        /// <summary>
        /// Gets or Sets TxBytes
        /// </summary>
        [DataMember(Name="txBytes", EmitDefaultValue=true)]
        public long? TxBytes { get; set; }

        /// <summary>
        /// Gets or Sets TxDropped
        /// </summary>
        [DataMember(Name="txDropped", EmitDefaultValue=true)]
        public long? TxDropped { get; set; }

        /// <summary>
        /// Gets or Sets TxErrors
        /// </summary>
        [DataMember(Name="txErrors", EmitDefaultValue=true)]
        ...
        [DataMember(Name="txPkts", EmitDefaultValue=true)]
