...
namespace Cohesity.Model
{
    ...
    public partial class AdObjectAttributeParameters :  IEquatable<AdObjectAttributeParameters>
    {
        ...
        public AdObjectAttributeParameters(List<RestoreAdGuidPair> adGuidPairs = default(List<RestoreAdGuidPair>), List<string> excludeLdapProperties = default(List<string>), List<string> ldapProperties = default(List<string>), bool? mergeMultiValProperties = default(bool?))
        {
        ...
        [DataMember(Name="adGuidPairs", EmitDefaultValue=false)]
        public List<RestoreAdGuidPair> AdGuidPairs { get; set; }
        ...
        [DataMember(Name="excludeLdapProperties", EmitDefaultValue=false)]
        ...
        [DataMember(Name="ldapProperties", EmitDefaultValue=false)]
        ...
        [DataMember(Name="mergeMultiValProperties", EmitDefaultValue=false)]
