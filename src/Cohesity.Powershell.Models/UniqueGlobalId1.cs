...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class UniqueGlobalId1 :  IEquatable<UniqueGlobalId1>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniqueGlobalId1" /> class.
        /// </summary>
        ...
        public UniqueGlobalId1(long? clusterId = default(long?), long? clusterIncarnationId = default(long?), long? id = default(long?))
        {
        ...
        {
            return this.Equals(input as UniqueGlobalId1);
        }

        /// <summary>
        /// Returns true if UniqueGlobalId1 instances are equal
        /// </summary>
        /// <param name="input">Instance of UniqueGlobalId1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniqueGlobalId1 input)
        {
            if (input == null)
                return false;
