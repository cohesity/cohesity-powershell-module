...
namespace Cohesity.Model
{
    ...
    public partial class AwsProtectionSource :  IEquatable<AwsProtectionSource>
    {
        ...
        public enum AwsTypeEnum
        {
            ...
            /// <summary>
            /// Enum KSubTaskPermit for value: kSubTaskPermit
            /// </summary>
            [EnumMember(Value = "kSubTaskPermit")]
            KSubTaskPermit = 19,

            /// <summary>
            /// Enum KS3Bucket for value: kS3Bucket
            /// </summary>
            [EnumMember(Value = "kS3Bucket")]
            KS3Bucket = 20,

            /// <summary>
            /// Enum KS3Tag for value: kS3Tag
            /// </summary>
            [EnumMember(Value = "kS3Tag")]
            KS3Tag = 21,

            /// <summary>
            /// Enum KKmsKey for value: kKmsKey
            /// </summary>
            [EnumMember(Value = "kKmsKey")]
            KKmsKey = 22
