...
{
    /// <summary>
    /// Specifies the View information.
    /// </summary>
    [DataContract]
    public partial class View1 :  IEquatable<View1>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as View1);
        }

        /// <summary>
        /// Returns true if View1 instances are equal
        /// </summary>
        /// <param name="input">Instance of View1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(View1 input)
        {
            if (input == null)
                return false;
