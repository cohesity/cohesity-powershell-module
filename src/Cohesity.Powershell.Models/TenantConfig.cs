...
namespace Cohesity.Model
{
    ...
    public partial class TenantConfig :  IEquatable<TenantConfig>
    {
        ...
        public TenantConfig(bool? bifrostEnabled = default(bool?), bool? isManagedOnHelios = default(bool?), string name = default(string), bool? restricted = default(bool?), List<string> roles = default(List<string>), string tenantId = default(string))
        {
