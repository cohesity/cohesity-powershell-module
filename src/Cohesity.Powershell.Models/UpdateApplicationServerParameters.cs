...
namespace Cohesity.Model
{
    ...
    public partial class UpdateApplicationServerParameters :  IEquatable<UpdateApplicationServerParameters>
    {
        ...
        public UpdateApplicationServerParameters(List<ApplicationsEnum> applications = default(List<ApplicationsEnum>), CloudCredentials cloudCredentials = default(CloudCredentials), string encryptionKey = default(string), bool? hasPersistentAgent = default(bool?), bool? isInternalEncrypted = default(bool?), long? lastModificationTimeUsecs = default(long?), string password = default(string), long? protectionSourceId = default(long?), string username = default(string))
        {
