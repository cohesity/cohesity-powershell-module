...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class EULAAcceptanceInformation_ :  IEquatable<EULAAcceptanceInformation_>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EULAAcceptanceInformation_" /> class.
        /// </summary>
        ...
        public EULAAcceptanceInformation_(string licenseKey = default(string), long? signedVersion = default(long?))
        {
        ...
        {
            return this.Equals(input as EULAAcceptanceInformation_);
        }

        /// <summary>
        /// Returns true if EULAAcceptanceInformation_ instances are equal
        /// </summary>
        /// <param name="input">Instance of EULAAcceptanceInformation_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EULAAcceptanceInformation_ input)
        {
            if (input == null)
                return false;
