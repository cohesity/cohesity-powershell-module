...
namespace Cohesity.Model
{
    ...
    public partial class ProtectionRunResponse :  IEquatable<ProtectionRunResponse>
    {
        ...
        [DataMember(Name="archivalRuns", EmitDefaultValue=true)]
        ...
        [DataMember(Name="backupRuns", EmitDefaultValue=true)]
        ...
        [DataMember(Name="replicationRuns", EmitDefaultValue=true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProtectionRunResponse {\n");
            sb.Append("  ArchivalRuns: ").Append(ArchivalRuns).Append("\n");
            sb.Append("  BackupRuns: ").Append(BackupRuns).Append("\n");
            sb.Append("  ReplicationRuns: ").Append(ReplicationRuns).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
