...
namespace Cohesity.Model
{
    ...
    public partial class RestoreVMwareVMParams :  IEquatable<RestoreVMwareVMParams>
    {
        ...
        public RestoreVMwareVMParams(bool? attemptDifferentialRestore = default(bool?), string catalogUuid = default(string), bool? copyRecovery = default(bool?), List<EntityProto> datastoreEntityVec = default(List<EntityProto>), string orgVdcNetworkName = default(string), string orgVdcNetworkVcdUuid = default(string), bool? overwriteExistingVm = default(bool?), bool? powerOffAndRenameExistingVm = default(bool?), bool? preserveCustomAttributesDuringClone = default(bool?), bool? preserveTagsDuringClone = default(bool?), EntityProto resourcePoolEntity = default(EntityProto), string storageProfileName = default(string), string storageProfileVcdUuid = default(string), EntityProto targetDatastoreFolder = default(EntityProto), EntityProto targetVmFolder = default(EntityProto))
        {
        ...
        [DataMember(Name="attemptDifferentialRestore", EmitDefaultValue=false)]
        ...
        [DataMember(Name="catalogUuid", EmitDefaultValue=false)]
        ...
        [DataMember(Name="orgVdcNetworkName", EmitDefaultValue=false)]
        ...
        [DataMember(Name="orgVdcNetworkVcdUuid", EmitDefaultValue=false)]
        ...
        [DataMember(Name="overwriteExistingVm", EmitDefaultValue=false)]
        ...
        [DataMember(Name="powerOffAndRenameExistingVm", EmitDefaultValue=false)]
        ...
        [DataMember(Name="preserveCustomAttributesDuringClone", EmitDefaultValue=false)]
        ...
        [DataMember(Name="preserveTagsDuringClone", EmitDefaultValue=false)]
        ...
        [DataMember(Name="storageProfileName", EmitDefaultValue=false)]
        ...
        [DataMember(Name="storageProfileVcdUuid", EmitDefaultValue=false)]
