...
namespace Cohesity.Models
{
    ...
    public partial class KvmProtectionSource :  IEquatable<KvmProtectionSource>
    {
        ...
        public KvmProtectionSource(string agentError = default(string), long? agentId = default(long?), string clusterId = default(string), string datacenterId = default(string), string description = default(string), string name = default(string), TypeEnum? type = default(TypeEnum?), string uuid = default(string))
        {
