...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class RemoteRestoreIndexingStatus :  IEquatable<RemoteRestoreIndexingStatus>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RemoteRestoreIndexingStatus);
        }

        /// <summary>
        /// Returns true if RemoteRestoreIndexingStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of RemoteRestoreIndexingStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoteRestoreIndexingStatus input)
        {
            if (input == null)
                return false;
