...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProtectionSummaryInformationOfARegisteredProtectionSourceTreeOrtheCohesityCluster1 :  IEquatable<ProtectionSummaryInformationOfARegisteredProtectionSourceTreeOrtheCohesityCluster1>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProtectionSummaryInformationOfARegisteredProtectionSourceTreeOrtheCohesityCluster1" /> class.
        /// </summary>
        ...
        public ProtectionSummaryInformationOfARegisteredProtectionSourceTreeOrtheCohesityCluster1(long? protectedCount = default(long?), long? protectedSize = default(long?), long? unprotectedCount = default(long?), long? unprotectedSize = default(long?))
        {
        ...
        {
            return this.Equals(input as ProtectionSummaryInformationOfARegisteredProtectionSourceTreeOrtheCohesityCluster1);
        }

        /// <summary>
        /// Returns true if ProtectionSummaryInformationOfARegisteredProtectionSourceTreeOrtheCohesityCluster1 instances are equal
        /// </summary>
        /// <param name="input">Instance of ProtectionSummaryInformationOfARegisteredProtectionSourceTreeOrtheCohesityCluster1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProtectionSummaryInformationOfARegisteredProtectionSourceTreeOrtheCohesityCluster1 input)
        {
            if (input == null)
                return false;
