...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class RemoteAdapter_ :  IEquatable<RemoteAdapter_>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoteAdapter_" /> class.
        /// </summary>
        ...
        public RemoteAdapter_(FullNoCBTScript_ fullBackupScript = default(FullNoCBTScript_), CBTbasedScript_ incrementalBackupScript = default(CBTbasedScript_), LogScript_ logBackupScript = default(LogScript_), RemoteHost_ remoteHost = default(RemoteHost_), string username = default(string))
        {
        ...
        //    sb.Append("class RemoteAdapter_ {\n");
        ...
        {
            return this.Equals(input as RemoteAdapter_);
        }

        /// <summary>
        /// Returns true if RemoteAdapter_ instances are equal
        /// </summary>
        /// <param name="input">Instance of RemoteAdapter_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoteAdapter_ input)
        {
            if (input == null)
                return false;
