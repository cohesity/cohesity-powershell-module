...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class EndTime_ :  IEquatable<EndTime_>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EndTime_" /> class.
        /// </summary>
        /// <param name="hour">Specifies an (0-23) hour in a day..</param>
        /// <param name="minute">Specifies a (0-59) minute in an hour..</param>
        public EndTime_(int? hour = default(int?), int? minute = default(int?))
        {
            this.Hour = hour;
            this.Minute = minute;
        }
        ...
        {
            return this.Equals(input as EndTime_);
        }

        /// <summary>
        /// Returns true if EndTime_ instances are equal
        /// </summary>
        /// <param name="input">Instance of EndTime_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EndTime_ input)
        {
            if (input == null)
                return false;
