...
namespace Cohesity.Model
{
    ...
    public partial class PackageDetails :  IEquatable<PackageDetails>
    {
        ...
        [DataMember(Name="downtimeRequired", EmitDefaultValue=true)]
        ...
        [DataMember(Name="installedOnNodes", EmitDefaultValue=true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DowntimeRequired: ").Append(DowntimeRequired).Append("\n");
            sb.Append("  InstalledOnNodes: ").Append(InstalledOnNodes).Append("\n");
