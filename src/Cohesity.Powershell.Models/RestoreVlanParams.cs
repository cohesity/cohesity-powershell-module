...
namespace Cohesity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RestoreVlanParams :  IEquatable<RestoreVlanParams>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RestoreVlanParams" /> class.
        /// </summary>
        ...
        public RestoreVlanParams(bool? disableVlan = default(bool?), string interfaceName = default(string), int? vlanId = default(int?))
        {
        ...
        {
            return this.Equals(input as RestoreVlanParams);
        }

        /// <summary>
        /// Returns true if RestoreVlanParams instances are equal
        /// </summary>
        /// <param name="input">Instance of RestoreVlanParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RestoreVlanParams input)
        {
            if (input == null)
                return false;
