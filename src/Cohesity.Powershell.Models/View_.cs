...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class View_ :  IEquatable<View_>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="View_" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as View_);
        }

        /// <summary>
        /// Returns true if View_ instances are equal
        /// </summary>
        /// <param name="input">Instance of View_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(View_ input)
        {
            if (input == null)
                return false;
