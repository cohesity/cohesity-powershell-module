...
{
    /// <summary>
    /// FortKnoxAzureInfo holds information about the Fortknox Azure or Azure FreeTrial subscription such as if it is active.
    /// </summary>
    [DataContract]
    public partial class FortKnoxAzureInfo :  IEquatable<FortKnoxAzureInfo>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as FortKnoxAzureInfo);
        }

        /// <summary>
        /// Returns true if FortKnoxAzureInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of FortKnoxAzureInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FortKnoxAzureInfo input)
        {
            if (input == null)
                return false;
