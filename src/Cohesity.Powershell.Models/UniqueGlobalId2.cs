...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class UniqueGlobalId2 :  IEquatable<UniqueGlobalId2>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniqueGlobalId2" /> class.
        /// </summary>
        ...
        public UniqueGlobalId2(long? clusterId = default(long?), long? clusterIncarnationId = default(long?), long? id = default(long?))
        {
        ...
        {
            return this.Equals(input as UniqueGlobalId2);
        }

        /// <summary>
        /// Returns true if UniqueGlobalId2 instances are equal
        /// </summary>
        /// <param name="input">Instance of UniqueGlobalId2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniqueGlobalId2 input)
        {
            if (input == null)
                return false;
