...
{
    /// <summary>
    /// Specifies the properties associated to a Centrify zone of an Active Directory domain.
    /// </summary>
    [DataContract]
    public partial class CentrifyZone :  IEquatable<CentrifyZone>
    {
        /// <summary>
        ...
        public CentrifyZone(CentrifySchemaEnum? centrifySchema = default(CentrifySchemaEnum?), string description = default(string), string distinguishedName = default(string))
        {
        ...
        {
            return this.Equals(input as CentrifyZone);
        }

        /// <summary>
        /// Returns true if CentrifyZone instances are equal
        /// </summary>
        /// <param name="input">Instance of CentrifyZone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CentrifyZone input)
        {
            if (input == null)
                return false;
