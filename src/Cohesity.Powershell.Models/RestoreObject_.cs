...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class RestoreObject_ :  IEquatable<RestoreObject_>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RestoreObject_" /> class.
        /// </summary>
        ...
        public RestoreObject_(ArchivalTarget_ archivalTarget = default(ArchivalTarget_), long? jobId = default(long?), long? jobRunId = default(long?), UniversalId_ jobUid = default(UniversalId_), long? protectionSourceId = default(long?), long? startedTimeUsecs = default(long?))
        {
        ...
        {
            return this.Equals(input as RestoreObject_);
        }

        /// <summary>
        /// Returns true if RestoreObject_ instances are equal
        /// </summary>
        /// <param name="input">Instance of RestoreObject_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RestoreObject_ input)
        {
            if (input == null)
                return false;
