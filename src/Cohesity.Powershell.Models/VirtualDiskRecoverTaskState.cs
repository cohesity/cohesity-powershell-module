...
namespace Cohesity.Model
{
    ...
    public partial class VirtualDiskRecoverTaskState :  IEquatable<VirtualDiskRecoverTaskState>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VirtualDiskRecoverTaskState {\n");
            sb.Append("  Error: ").Append(Error).Append("\n");
            sb.Append("  IsInstantRecoveryFinished: ").Append(IsInstantRecoveryFinished).Append("\n");
            sb.Append("  TaskState: ").Append(TaskState).Append("\n");
            sb.Append("  VirtualDiskRestoreResponse: ").Append(VirtualDiskRestoreResponse).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
