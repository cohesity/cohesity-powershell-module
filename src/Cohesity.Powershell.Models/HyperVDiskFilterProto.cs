...
{
    /// <summary>
    /// This message contains basic info of the disk to be excluded/included in backup. The info contained here: 1. should be enough to identify the disk during the backup job. 2. is a subset of the message fetched to be displayed to the end user. Example: entities/hyperv.proto.
    /// </summary>
    [DataContract]
    public partial class HyperVDiskFilterProto :  IEquatable<HyperVDiskFilterProto>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HyperVDiskFilterProto" /> class.
        /// </summary>
        ...
        public HyperVDiskFilterProto(long? controllerBusNumber = default(long?), string controllerType = default(string), long? unitNumber = default(long?))
        {
        ...
        {
            return this.Equals(input as HyperVDiskFilterProto);
        }

        /// <summary>
        /// Returns true if HyperVDiskFilterProto instances are equal
        /// </summary>
        /// <param name="input">Instance of HyperVDiskFilterProto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HyperVDiskFilterProto input)
        {
            if (input == null)
                return false;
