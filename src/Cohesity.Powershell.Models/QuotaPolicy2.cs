...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuotaPolicy2 :  IEquatable<QuotaPolicy2>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuotaPolicy2" /> class.
        /// </summary>
        ...
        public QuotaPolicy2(string alertLimit = default(string), string hardLimit = default(string), long? alertLimitBytes = default(long?), long? alertThresholdPercentage = default(long?), long? hardLimitBytes = default(long?))
        {
        ...
        {
            return this.Equals(input as QuotaPolicy2);
        }

        /// <summary>
        /// Returns true if QuotaPolicy2 instances are equal
        /// </summary>
        /// <param name="input">Instance of QuotaPolicy2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuotaPolicy2 input)
        {
            if (input == null)
                return false;
