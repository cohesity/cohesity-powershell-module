...
namespace Cohesity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateApiKeyParams :  IEquatable<CreateApiKeyParams>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateApiKeyParams" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateApiKeyParams() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateApiKeyParams" /> class.
        /// </summary>
        ...
        public CreateApiKeyParams(long? expiringTimeMsecs = default(long?), bool? isActive = default(bool?), string name = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for CreateApiKeyParams and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            return this.Equals(input as CreateApiKeyParams);
        }

        /// <summary>
        /// Returns true if CreateApiKeyParams instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateApiKeyParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateApiKeyParams input)
        {
            if (input == null)
                return false;
