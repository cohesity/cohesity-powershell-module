...
namespace Cohesity.Models
{
    ...
    public partial class SqlProtectionSource :  IEquatable<SqlProtectionSource>
    {
        ...
        public SqlProtectionSource(bool? isAvailableForVssBackup = default(bool?), string createdTimestamp = default(string), string databaseName = default(string), long? dbAagEntityId = default(long?), string dbAagName = default(string), List<DbFileInfo> dbFiles = default(List<DbFileInfo>), SqlSourceId id = default(SqlSourceId), string name = default(string), long? ownerId = default(long?), RecoveryModelEnum? recoveryModel = default(RecoveryModelEnum?), string sqlServerDbState = default(string), TypeEnum? type = default(TypeEnum?))
        {
