...
namespace Cohesity.Model
{
    ...
    public partial class LdapProvider :  IEquatable<LdapProvider>
    {
        ...
        public LdapProvider(string adDomainName = default(string), string attributeCommonName = default(string), string attributeGid = default(string), string attributeMemberOf = default(string), string attributeUid = default(string), string attributeUserName = default(string), AuthTypeEnum? authType = default(AuthTypeEnum?), string baseDistinguishedName = default(string), string domainName = default(string), string name = default(string), string objectClassGroup = default(string), string objectClassUser = default(string), int? port = default(int?), List<string> preferredLdapServerList = default(List<string>), string tenantId = default(string), bool? useSsl = default(bool?), string userDistinguishedName = default(string), string userPassword = default(string))
        {
