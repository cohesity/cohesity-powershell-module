...
namespace Cohesity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateProtectionJobsStateParams :  IEquatable<UpdateProtectionJobsStateParams>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateProtectionJobsStateParams" /> class.
        /// </summary>
        ...
        public UpdateProtectionJobsStateParams(ActionEnum? action = default(ActionEnum?), List<long> jobIds = default(List<long>))
        {
            this.Action = action;
            this.JobIds = jobIds;
            this.Action = action;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateProtectionJobsStateParams {\n");
        ...
        {
            return this.Equals(input as UpdateProtectionJobsStateParams);
        }

        /// <summary>
        /// Returns true if UpdateProtectionJobsStateParams instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateProtectionJobsStateParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateProtectionJobsStateParams input)
        {
            if (input == null)
                return false;
