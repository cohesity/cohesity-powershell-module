...
namespace Cohesity.Model
{
    ...
    public partial class PodMetadataVolumeInfo :  IEquatable<PodMetadataVolumeInfo>
    {
        ...
        public PodMetadataVolumeInfo(string pvName = default(string), PodInfoPodSpecVolumeInfo volume = default(PodInfoPodSpecVolumeInfo), string volumePath = default(string))
        {
            this.PvName = pvName;
            this.Volume = volume;
