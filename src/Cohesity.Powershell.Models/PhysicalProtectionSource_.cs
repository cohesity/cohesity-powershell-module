...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class PhysicalProtectionSource_ :  IEquatable<PhysicalProtectionSource_>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PhysicalProtectionSource_" /> class.
        /// </summary>
        ...
        public PhysicalProtectionSource_(List<AgentInformation> agents = default(List<AgentInformation>), HostTypeEnum? hostType = default(HostTypeEnum?), UniqueGlobalId4 id = default(UniqueGlobalId4), string name = default(string), TypeEnum? type = default(TypeEnum?), List<PhysicalVolume> volumes = default(List<PhysicalVolume>))
        {
            this.Agents = agents;
        ...
        {
            return this.Equals(input as PhysicalProtectionSource_);
        }

        /// <summary>
        /// Returns true if PhysicalProtectionSource_ instances are equal
        /// </summary>
        /// <param name="input">Instance of PhysicalProtectionSource_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PhysicalProtectionSource_ input)
        {
            if (input == null)
                return false;
