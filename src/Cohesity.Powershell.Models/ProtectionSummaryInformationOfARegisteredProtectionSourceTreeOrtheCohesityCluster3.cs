...
{
    /// <summary>
    /// Specifies the stats of protection information of the View.
    /// </summary>
    [DataContract]
    public partial class ProtectionSummaryInformationOfARegisteredProtectionSourceTreeOrtheCohesityCluster3 :  IEquatable<ProtectionSummaryInformationOfARegisteredProtectionSourceTreeOrtheCohesityCluster3>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProtectionSummaryInformationOfARegisteredProtectionSourceTreeOrtheCohesityCluster3" /> class.
        /// </summary>
        ...
        public ProtectionSummaryInformationOfARegisteredProtectionSourceTreeOrtheCohesityCluster3(long? protectedCount = default(long?), long? protectedSize = default(long?), long? unprotectedCount = default(long?), long? unprotectedSize = default(long?))
        {
        ...
        {
            return this.Equals(input as ProtectionSummaryInformationOfARegisteredProtectionSourceTreeOrtheCohesityCluster3);
        }

        /// <summary>
        /// Returns true if ProtectionSummaryInformationOfARegisteredProtectionSourceTreeOrtheCohesityCluster3 instances are equal
        /// </summary>
        /// <param name="input">Instance of ProtectionSummaryInformationOfARegisteredProtectionSourceTreeOrtheCohesityCluster3 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProtectionSummaryInformationOfARegisteredProtectionSourceTreeOrtheCohesityCluster3 input)
        {
            if (input == null)
                return false;
