...
namespace Cohesity.Model
{
    ...
    public partial class HypervCloneParameters :  IEquatable<HypervCloneParameters>
    {
        ...
        public HypervCloneParameters(bool? disableNetwork = default(bool?), long? networkId = default(long?), bool? poweredOn = default(bool?), string prefix = default(string), long? resourceId = default(long?), string suffix = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HypervCloneParameters {\n");
