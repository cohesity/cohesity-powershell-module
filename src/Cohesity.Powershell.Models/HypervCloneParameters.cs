...
{
    /// <summary>
    /// Specifies information needed when cloning VMs in HyperV enviroment. This field defines the HyperV specific params for restore tasks of type kCloneVMs.
    /// </summary>
    [DataContract]
    public partial class HypervCloneParameters :  IEquatable<HypervCloneParameters>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HypervCloneParameters" /> class.
        /// </summary>
        ...
        public HypervCloneParameters(bool? disableNetwork = default(bool?), long? networkId = default(long?), bool? poweredOn = default(bool?), string prefix = default(string), bool? preserveTags = default(bool?), long? resourceId = default(long?), string suffix = default(string))
        {
        ...
        {
            return this.Equals(input as HypervCloneParameters);
        }

        /// <summary>
        /// Returns true if HypervCloneParameters instances are equal
        /// </summary>
        /// <param name="input">Instance of HypervCloneParameters to be compared</param>
        /// <returns>Boolean</returns>
