...
namespace Cohesity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RegisterApplicationServersParameters :  IEquatable<RegisterApplicationServersParameters>
    {
        /// <summary>
        ...
        public RegisterApplicationServersParameters(List<ApplicationsEnum> applications = default(List<ApplicationsEnum>), CloudCredentials cloudCredentials = default(CloudCredentials), string encryptionKey = default(string), bool? hasPersistentAgent = default(bool?), bool? isInternalEncrypted = default(bool?), string password = default(string), long? protectionSourceId = default(long?), string username = default(string))
        {
        ...
        {
            return this.Equals(input as RegisterApplicationServersParameters);
        }

        /// <summary>
        /// Returns true if RegisterApplicationServersParameters instances are equal
        /// </summary>
        /// <param name="input">Instance of RegisterApplicationServersParameters to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RegisterApplicationServersParameters input)
        {
            if (input == null)
                return false;
