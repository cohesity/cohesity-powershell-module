...
namespace Cohesity.Model
{
    ...
    public partial class RegisterApplicationServersParameters :  IEquatable<RegisterApplicationServersParameters>
    {
        ...
        public RegisterApplicationServersParameters(List<ApplicationsEnum> applications = default(List<ApplicationsEnum>), bool? hasPersistentAgent = default(bool?), string password = default(string), long? protectionSourceId = default(long?), string username = default(string))
        {
