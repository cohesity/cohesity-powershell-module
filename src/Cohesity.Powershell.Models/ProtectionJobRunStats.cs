...
namespace Cohesity.Model
{
    ...
    public partial class ProtectionJobRunStats :  IEquatable<ProtectionJobRunStats>
    {
        ...
        [DataMember(Name="numCancelledAppObjects", EmitDefaultValue=true)]
