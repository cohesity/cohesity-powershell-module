...
namespace Cohesity.Model
{
    ...
    public partial class ClusterStatusResult :  IEquatable<ClusterStatusResult>
    {
        ...
        [DataMember(Name="stoppedServices", EmitDefaultValue=true)]
        ...
        /// </summary>
        /// <param name="airgapConfig">airgapConfig.</param>
        ...
        /// <summary>
        /// Gets or Sets AirgapConfig
        /// </summary>
        [DataMember(Name="airgapConfig", EmitDefaultValue=false)]
        public AirgapConfig AirgapConfig { get; set; }
        ...
        [DataMember(Name="nodeStatuses", EmitDefaultValue=true)]
        ...
        [DataMember(Name="servicesSynced", EmitDefaultValue=true)]
        ...
        [DataMember(Name="systemAppStatus", EmitDefaultValue=true)]
        ...
        public bool Equals(ClusterStatusResult input)
        {
            ...
            return 
                (
                    this.AirgapConfig == input.AirgapConfig ||
                    (this.AirgapConfig != null &&
                    this.AirgapConfig.Equals(input.AirgapConfig))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.AirgapConfig != null)
                    hashCode = hashCode * 59 + this.AirgapConfig.GetHashCode();
