...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class LocalStatistics_ :  IEquatable<LocalStatistics_>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LocalStatistics_" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as LocalStatistics_);
        }

        /// <summary>
        /// Returns true if LocalStatistics_ instances are equal
        /// </summary>
        /// <param name="input">Instance of LocalStatistics_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LocalStatistics_ input)
        {
            if (input == null)
                return false;
