...
namespace Cohesity.Model
{
    ...
    public partial class SnapshotReplicationCopyPolicy :  IEquatable<SnapshotReplicationCopyPolicy>
    {
        ...
        /// <summary>
        /// Gets or Sets CloudTarget
        /// </summary>
        [DataMember(Name="cloudTarget", EmitDefaultValue=false)]
        public CloudDeployTargetDetails CloudTarget { get; set; }
        ...
        /// </summary>
        /// <value>Specifies a the source cluster id from which the data must be replicated.</value>
        ...
        /// </summary>
        /// <value>Specifies the replication target to copy the Snapshots to.</value>
        [DataMember(Name="target", EmitDefaultValue=true)]
        public ReplicationTargetSettings Target { get; set; }
        ...
        public bool Equals(SnapshotReplicationCopyPolicy input)
        {
            ...
            return 
                ...
                (
                    this.CloudTarget == input.CloudTarget ||
                    (this.CloudTarget != null &&
                    this.CloudTarget.Equals(input.CloudTarget))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CloudTarget != null)
                    hashCode = hashCode * 59 + this.CloudTarget.GetHashCode();
