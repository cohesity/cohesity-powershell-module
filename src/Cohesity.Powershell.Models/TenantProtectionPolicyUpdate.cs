...
namespace Cohesity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TenantProtectionPolicyUpdate :  IEquatable<TenantProtectionPolicyUpdate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TenantProtectionPolicyUpdate" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TenantProtectionPolicyUpdate {\n");
        ...
        {
            return this.Equals(input as TenantProtectionPolicyUpdate);
        }

        /// <summary>
        /// Returns true if TenantProtectionPolicyUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of TenantProtectionPolicyUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TenantProtectionPolicyUpdate input)
        {
            if (input == null)
                return false;
