...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class StatusOfSnapshotRestoreTask_ :  IEquatable<StatusOfSnapshotRestoreTask_>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StatusOfSnapshotRestoreTask_" /> class.
        /// </summary>
        ...
        public StatusOfSnapshotRestoreTask_(ArchiveTaskUid2 archiveTaskUid = default(ArchiveTaskUid2), string error = default(string), long? expiryTimeUsecs = default(long?), long? jobRunId = default(long?), string progressMonitorTask = default(string), SnapshotTaskStatusEnum? snapshotTaskStatus = default(SnapshotTaskStatusEnum?), SnapshotTaskUid_ snapshotTaskUid = default(SnapshotTaskUid_), long? snapshotTimeUsecs = default(long?))
        {
        ...
        {
            return this.Equals(input as StatusOfSnapshotRestoreTask_);
        }

        /// <summary>
        /// Returns true if StatusOfSnapshotRestoreTask_ instances are equal
        /// </summary>
        /// <param name="input">Instance of StatusOfSnapshotRestoreTask_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StatusOfSnapshotRestoreTask_ input)
        {
            if (input == null)
                return false;
