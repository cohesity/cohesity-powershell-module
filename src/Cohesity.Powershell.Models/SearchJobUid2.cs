...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class SearchJobUid2 :  IEquatable<SearchJobUid2>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchJobUid2" /> class.
        /// </summary>
        ...
        public SearchJobUid2(long? clusterId = default(long?), long? clusterIncarnationId = default(long?), long? id = default(long?))
        {
        ...
        {
            return this.Equals(input as SearchJobUid2);
        }

        /// <summary>
        /// Returns true if SearchJobUid2 instances are equal
        /// </summary>
        /// <param name="input">Instance of SearchJobUid2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SearchJobUid2 input)
        {
            if (input == null)
                return false;
