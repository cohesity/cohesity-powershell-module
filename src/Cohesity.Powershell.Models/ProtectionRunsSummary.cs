...
namespace Cohesity.Model
{
    ...
    public partial class ProtectionRunsSummary :  IEquatable<ProtectionRunsSummary>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProtectionRunsSummary {\n");
            sb.Append("  NumberOfArchivalRuns: ").Append(NumberOfArchivalRuns).Append("\n");
            sb.Append("  NumberOfProtectionRuns: ").Append(NumberOfProtectionRuns).Append("\n");
            sb.Append("  NumberOfReplicationRuns: ").Append(NumberOfReplicationRuns).Append("\n");
            sb.Append("  NumberOfSuccessfulArchivalRuns: ").Append(NumberOfSuccessfulArchivalRuns).Append("\n");
            sb.Append("  NumberOfSuccessfulProtectionRuns: ").Append(NumberOfSuccessfulProtectionRuns).Append("\n");
            sb.Append("  NumberOfSuccessfulReplicationRuns: ").Append(NumberOfSuccessfulReplicationRuns).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
