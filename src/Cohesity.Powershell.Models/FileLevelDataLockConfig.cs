...
namespace Cohesity.Model
{
    ...
    public partial class FileLevelDataLockConfig :  IEquatable<FileLevelDataLockConfig>
    {
        ...
        /// <param name="coexistingLockMode">Specified if files in the View can be locked in different modes. This property is immutable and can only be set when enabling File level datalock. If this property is set for an S3 View, S3 bucket Versioning should also be enabled..</param>
        ...
        public FileLevelDataLockConfig(int? autoLockAfterDurationIdle = default(int?), bool? coexistingLockMode = default(bool?), long? defaultFileRetentionDurationMsecs = default(long?), int? expiryTimestampMsecs = default(int?), LockingProtocolEnum? lockingProtocol = default(LockingProtocolEnum?), long? maxRetentionDurationMsecs = default(long?), long? minRetentionDurationMsecs = default(long?), ModeEnum? mode = default(ModeEnum?))
        {
        ...
        /// </summary>
        /// <value>Specified if files in the View can be locked in different modes. This property is immutable and can only be set when enabling File level datalock. If this property is set for an S3 View, S3 bucket Versioning should also be enabled.</value>
