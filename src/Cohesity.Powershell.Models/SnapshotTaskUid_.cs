...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class SnapshotTaskUid_ :  IEquatable<SnapshotTaskUid_>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SnapshotTaskUid_" /> class.
        /// </summary>
        ...
        public SnapshotTaskUid_(long? clusterId = default(long?), long? clusterIncarnationId = default(long?), long? id = default(long?))
        {
        ...
        {
            return this.Equals(input as SnapshotTaskUid_);
        }

        /// <summary>
        /// Returns true if SnapshotTaskUid_ instances are equal
        /// </summary>
        /// <param name="input">Instance of SnapshotTaskUid_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SnapshotTaskUid_ input)
        {
            if (input == null)
                return false;
