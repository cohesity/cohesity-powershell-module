...
namespace Cohesity.Model
{
    ...
    public partial class AdRestoreOptions :  IEquatable<AdRestoreOptions>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdRestoreOptions {\n");
            sb.Append("  ObjectAttributeParameters: ").Append(ObjectAttributeParameters).Append("\n");
            sb.Append("  ObjectParameters: ").Append(ObjectParameters).Append("\n");
