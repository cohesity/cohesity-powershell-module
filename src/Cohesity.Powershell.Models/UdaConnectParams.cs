...
namespace Cohesity.Model
{
    ...
    public partial class UdaConnectParams :  IEquatable<UdaConnectParams>
    {
        ...
        public UdaConnectParams(UdaSourceCapabilities capabilities = default(UdaSourceCapabilities), Credentials credentials = default(Credentials), HostTypeEnum? hostType = default(HostTypeEnum?), List<string> hosts = default(List<string>), bool? liveDataView = default(bool?), bool? liveLogView = default(bool?), string mountDir = default(string), bool? mountView = default(bool?), string scriptDir = default(string), string sourceArgs = default(string), List<KeyValuePair> sourceRegistrationArguments = default(List<KeyValuePair>), string sourceType = default(string))
        {
            ...
            this.SourceRegistrationArguments = sourceRegistrationArguments;
        ...
        /// <summary>
        /// Custom arguments which will be provided to the source registration scripts. This is deprecated. Use &#39;sourceRegistrationArguments&#39; instead.
        /// </summary>
        /// <value>Custom arguments which will be provided to the source registration scripts. This is deprecated. Use &#39;sourceRegistrationArguments&#39; instead.</value>
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SourceRegistrationArguments != null)
                    hashCode = hashCode * 59 + this.SourceRegistrationArguments.GetHashCode();
