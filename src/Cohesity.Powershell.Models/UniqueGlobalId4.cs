...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class UniqueGlobalId4 :  IEquatable<UniqueGlobalId4>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniqueGlobalId4" /> class.
        /// </summary>
        ...
        public UniqueGlobalId4(long? clusterId = default(long?), long? clusterIncarnationId = default(long?), long? id = default(long?))
        {
        ...
        {
            return this.Equals(input as UniqueGlobalId4);
        }

        /// <summary>
        /// Returns true if UniqueGlobalId4 instances are equal
        /// </summary>
        /// <param name="input">Instance of UniqueGlobalId4 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniqueGlobalId4 input)
        {
            if (input == null)
                return false;
