...
namespace Cohesity.Model
{
    ...
    public partial class IcapConnectionStatusResponse :  IEquatable<IcapConnectionStatusResponse>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IcapConnectionStatusResponse {\n");
            sb.Append("  FailedConnectionStatus: ").Append(FailedConnectionStatus).Append("\n");
            sb.Append("  SucceededConnectionStatus: ").Append(SucceededConnectionStatus).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
