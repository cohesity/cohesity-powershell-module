...
namespace Cohesity.Model
{
    ...
    public partial class Vlan :  IEquatable<Vlan>
    {
        ...
        [DataMember(Name="appIpVecInUse", EmitDefaultValue=true)]
        ...
        [DataMember(Name="dnsDelegationZones", EmitDefaultValue=true)]
        ...
        [DataMember(Name="ecmpEnabled", EmitDefaultValue=true)]
        ...
        [DataMember(Name="interfaceGroupId", EmitDefaultValue=true)]
        ...
        [DataMember(Name="ipPoolMap", EmitDefaultValue=true)]
        ...
        [DataMember(Name="ipRanges", EmitDefaultValue=true)]
