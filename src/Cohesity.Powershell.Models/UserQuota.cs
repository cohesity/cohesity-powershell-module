...
namespace Cohesity.Model
{
    ...
    public partial class UserQuota :  IEquatable<UserQuota>
    {
        ...
        public UserQuota(string domain = default(string), QuotaPolicy quotaPolicy = default(QuotaPolicy), string sid = default(string), int? unixUid = default(int?), string userName = default(string))
        {
            this.Domain = domain;
            this.Sid = sid;
