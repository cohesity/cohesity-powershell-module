...
namespace Cohesity.Models
{
    ...
    public partial class AzureProtectionSource :  IEquatable<AzureProtectionSource>
    {
        ...
        public AzureProtectionSource(HostTypeEnum? hostType = default(HostTypeEnum?), List<string> ipAddresses = default(List<string>), string location = default(string), long? memoryMbytes = default(long?), string name = default(string), int? numCores = default(int?), string resourceId = default(string), TypeEnum? type = default(TypeEnum?))
        {
