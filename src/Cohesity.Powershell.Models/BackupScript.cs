...
{
    /// <summary>
    /// Specifies details about the pre and post backup scripts for &#39;kPhysical&#39; jobs.
    /// </summary>
    [DataContract]
    public partial class BackupScript :  IEquatable<BackupScript>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BackupScript" /> class.
        /// </summary>
        ...
        [DataMember(Name="fullBackupScript", EmitDefaultValue=true)]
        ...
        [DataMember(Name="incrementalBackupScript", EmitDefaultValue=true)]
        ...
        [DataMember(Name="logBackupScript", EmitDefaultValue=true)]
        ...
        [DataMember(Name="remoteHost", EmitDefaultValue=true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BackupScript {\n");
            sb.Append("  FullBackupScript: ").Append(FullBackupScript).Append("\n");
            sb.Append("  IncrementalBackupScript: ").Append(IncrementalBackupScript).Append("\n");
        ...
        {
            return this.Equals(input as BackupScript);
        }

        /// <summary>
        /// Returns true if BackupScript instances are equal
        /// </summary>
        /// <param name="input">Instance of BackupScript to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BackupScript input)
        {
            if (input == null)
                return false;
