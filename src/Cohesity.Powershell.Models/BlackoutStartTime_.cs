...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class BlackoutStartTime_ :  IEquatable<BlackoutStartTime_>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BlackoutStartTime_" /> class.
        /// </summary>
        /// <param name="hour">Specifies an (0-23) hour in a day..</param>
        /// <param name="minute">Specifies a (0-59) minute in an hour..</param>
        public BlackoutStartTime_(int? hour = default(int?), int? minute = default(int?))
        {
            this.Hour = hour;
            this.Minute = minute;
        }
        ...
        {
            return this.Equals(input as BlackoutStartTime_);
        }

        /// <summary>
        /// Returns true if BlackoutStartTime_ instances are equal
        /// </summary>
        /// <param name="input">Instance of BlackoutStartTime_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BlackoutStartTime_ input)
        {
            if (input == null)
                return false;
