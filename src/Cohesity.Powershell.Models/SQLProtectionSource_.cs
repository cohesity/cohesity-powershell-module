...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class SQLProtectionSource_ :  IEquatable<SQLProtectionSource_>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SQLProtectionSource_" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SQLProtectionSource_);
        }

        /// <summary>
        /// Returns true if SQLProtectionSource_ instances are equal
        /// </summary>
        /// <param name="input">Instance of SQLProtectionSource_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SQLProtectionSource_ input)
        {
            if (input == null)
                return false;
