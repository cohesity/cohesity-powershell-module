...
namespace Cohesity.Model
{
    ...
    public partial class UserInformation :  IEquatable<UserInformation>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IncludeSubtenantObjects: ").Append(IncludeSubtenantObjects).Append("\n");
            sb.Append("  PulseAttributeVec: ").Append(PulseAttributeVec).Append("\n");
            sb.Append("  SidVec: ").Append(SidVec).Append("\n");
