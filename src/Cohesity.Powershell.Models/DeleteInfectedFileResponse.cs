...
namespace Cohesity.Model
{
    ...
    public partial class DeleteInfectedFileResponse :  IEquatable<DeleteInfectedFileResponse>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteInfectedFileResponse {\n");
            sb.Append("  DeleteFailedInfectedFiles: ").Append(DeleteFailedInfectedFiles).Append("\n");
            sb.Append("  DeleteSucceededInfectedFiles: ").Append(DeleteSucceededInfectedFiles).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
