...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProtectionJobUid_ :  IEquatable<ProtectionJobUid_>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProtectionJobUid_" /> class.
        /// </summary>
        ...
        public ProtectionJobUid_(long? clusterId = default(long?), long? clusterIncarnationId = default(long?), long? id = default(long?))
        {
        ...
        {
            return this.Equals(input as ProtectionJobUid_);
        }

        /// <summary>
        /// Returns true if ProtectionJobUid_ instances are equal
        /// </summary>
        /// <param name="input">Instance of ProtectionJobUid_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProtectionJobUid_ input)
        {
            if (input == null)
                return false;
