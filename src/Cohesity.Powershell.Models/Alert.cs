...
namespace Cohesity.Model
{
    ...
    public partial class Alert :  IEquatable<Alert>
    {
        ...
        public enum AlertCategoryEnum
        {
            ...
            /// <summary>
            /// Enum KStorageDevice for value: kStorageDevice
            /// </summary>
            [EnumMember(Value = "kStorageDevice")]
            KStorageDevice = 36,

            /// <summary>
            /// Enum KStoragePool for value: kStoragePool
            /// </summary>
            [EnumMember(Value = "kStoragePool")]
            KStoragePool = 37,

            /// <summary>
            /// Enum KGeneralSoftwareFailure for value: kGeneralSoftwareFailure
            /// </summary>
            [EnumMember(Value = "kGeneralSoftwareFailure")]
            KGeneralSoftwareFailure = 38,
            ...
            /// <summary>
            /// Enum KNetBackup for value: kNetBackup
            /// </summary>
            [EnumMember(Value = "kNetBackup")]
            KNetBackup = 40
        ...
        /// </summary>
        /// <param name="alertCategory">Specifies the category of an Alert. kDisk - Alert associated with the disk. kNode - Alert associated with general hardware on a specific node. kCluster - Alert associated with general hardware in cluster level. kChassis - Alert associated with the Chassis. kPowerSupply - Alert associated with the power supply. kCPU - Alert associated with the CPU usage. kMemory - Alert associated with the RAM/Memory. kTemperature - Alert associated with the temperature. kFan - Alert associated with the fan. kNIC - Alert associated with network chips and interfaces. kFirmware - Alert associated with the firmware. kNodeHealth - Alert associated with node health status. kOperatingSystem - Alert associated with operating systems. kDataPath - Alert associated with data management in the cluster. kMetadata - Alert associated with metadata management. kIndexing - Alert associated with indexing services. kHelios - Alert associated with Helios. kAppMarketPlace - Alert associated with App MarketPlace. kSystemService -Alert associated with System service apps. kLicense - Alert associated with licensing. kSecurity - Alert associated with security. kUpgrade - Alert associated with upgrade activities. kClusterManagement - Alert associated with cluster management activities. kAuditLog - Alert associated with audit log events. kNetworking - Alert associated with networking issue. kConfiguration - Alert associated with cluster or system configurations. kStorageUsage - Alert associated with the disk/domain/cluster storage usage. kFaultTolerance - Alert associated with the fault tolerance in different levels. kBackupRestore - Alert associated with Backup-Restore job. kArchivalRestore - Alert associated with Archival-Restore job. kRemoteReplication - Alert associated with Replication job. kQuota - Alert associated with Quotas. kCDP - Alert associated with Continuous Data Protection. kViewFailover - Alert associated with view Failover. kDisasterRecovery - Alert associated with Disaster Recovery. kStorageDevice - Alert associated with storage hardware(tape drives &amp; libraries, Fiber HBAs used to attach devices, etc). kStoragePool - Alert associated with storage pools - - logical groupings of similar kinds of storage hardware (disk, tape, etc) into which client data is stored. kGeneralSoftwareFailure - Alert associated with general software failures - that don&#39;t fall into any known categories. kAgent - Alert associated with agent based protection workloads. kNetBackup - Alert associated with NetBackup..</param>
        ...
        /// <param name="labelIds">Specifies the labels for which this alert has been raised..</param>
        ...
        /// <param name="resolutionIdString">Resolution Id String.</param>
        /// <param name="resolvedTimestampUsecs">Specifies Unix epoch Timestamps in microseconds when alert is resolved..</param>
        /// <param name="serviceInstanceIds">List of service instances an alert was raised for.</param>
        ...
        /// <param name="vaults">Vaults where source object associated with alert is vaulted..</param>
        public Alert(AlertCategoryEnum? alertCategory = default(AlertCategoryEnum?), string alertCode = default(string), AlertDocument alertDocument = default(AlertDocument), AlertStateEnum? alertState = default(AlertStateEnum?), int? alertType = default(int?), AlertTypeBucketEnum? alertTypeBucket = default(AlertTypeBucketEnum?), long? clusterId = default(long?), string clusterName = default(string), int? dedupCount = default(int?), List<long> dedupTimestamps = default(List<long>), string eventSource = default(string), long? firstTimestampUsecs = default(long?), string id = default(string), List<string> labelIds = default(List<string>), long? latestTimestampUsecs = default(long?), List<AlertProperty> propertyList = default(List<AlertProperty>), string regionId = default(string), AlertResolutionDetails resolutionDetails = default(AlertResolutionDetails), string resolutionIdString = default(string), long? resolvedTimestampUsecs = default(long?), List<string> serviceInstanceIds = default(List<string>), SeverityEnum? severity = default(SeverityEnum?), long? suppressionId = default(long?), List<string> tenantIds = default(List<string>), List<AlertVaultInfo> vaults = default(List<AlertVaultInfo>))
        {
            ...
            this.ResolutionIdString = resolutionIdString;
        ...
        /// </summary>
        /// <value>Specifies the labels for which this alert has been raised.</value>
        ...
        /// </summary>
        /// <value>Resolution Id String</value>
        [DataMember(Name="resolutionIdString", EmitDefaultValue=true)]
        public string ResolutionIdString { get; set; }
        ...
        /// </summary>
        /// <value>List of service instances an alert was raised for</value>
        [DataMember(Name="serviceInstanceIds", EmitDefaultValue=true)]
        public List<string> ServiceInstanceIds { get; set; }
        ...
        /// </summary>
        /// <value>Vaults where source object associated with alert is vaulted.</value>
        [DataMember(Name="vaults", EmitDefaultValue=true)]
        public List<AlertVaultInfo> Vaults { get; set; }
        ...
        public bool Equals(Alert input)
        {
            ...
            return 
                ...
                (
                    this.ResolutionIdString == input.ResolutionIdString ||
                    (this.ResolutionIdString != null &&
                    this.ResolutionIdString.Equals(input.ResolutionIdString))
                ) && 
                (
                ...
                (
                    this.ServiceInstanceIds == input.ServiceInstanceIds ||
                    this.ServiceInstanceIds != null &&
                    input.ServiceInstanceIds != null &&
                    this.ServiceInstanceIds.SequenceEqual(input.ServiceInstanceIds)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ResolutionIdString != null)
                    hashCode = hashCode * 59 + this.ResolutionIdString.GetHashCode();
                ...
                if (this.ServiceInstanceIds != null)
                    hashCode = hashCode * 59 + this.ServiceInstanceIds.GetHashCode();
