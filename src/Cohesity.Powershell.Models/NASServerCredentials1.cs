...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class NASServerCredentials1 :  IEquatable<NASServerCredentials1>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NASServerCredentials1" /> class.
        /// </summary>
        ...
        public NASServerCredentials1(string domain = default(string), NasProtocolEnum? nasProtocol = default(NasProtocolEnum?), string password = default(string), string username = default(string))
        {
            this.Domain = domain;
        ...
        {
            return this.Equals(input as NASServerCredentials1);
        }

        /// <summary>
        /// Returns true if NASServerCredentials1 instances are equal
        /// </summary>
        /// <param name="input">Instance of NASServerCredentials1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NASServerCredentials1 input)
        {
            if (input == null)
                return false;
