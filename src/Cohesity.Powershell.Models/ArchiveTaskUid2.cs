...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ArchiveTaskUid2 :  IEquatable<ArchiveTaskUid2>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchiveTaskUid2" /> class.
        /// </summary>
        ...
        public ArchiveTaskUid2(long? clusterId = default(long?), long? clusterIncarnationId = default(long?), long? id = default(long?))
        {
        ...
        {
            return this.Equals(input as ArchiveTaskUid2);
        }

        /// <summary>
        /// Returns true if ArchiveTaskUid2 instances are equal
        /// </summary>
        /// <param name="input">Instance of ArchiveTaskUid2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArchiveTaskUid2 input)
        {
            if (input == null)
                return false;
