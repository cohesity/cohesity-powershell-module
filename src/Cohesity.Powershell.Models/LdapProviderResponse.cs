...
namespace Cohesity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LdapProviderResponse :  IEquatable<LdapProviderResponse>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LdapProviderResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as LdapProviderResponse);
        }

        /// <summary>
        /// Returns true if LdapProviderResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of LdapProviderResponse to be compared</param>
        /// <returns>Boolean</returns>
