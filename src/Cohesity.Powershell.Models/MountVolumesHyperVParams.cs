...
namespace Cohesity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MountVolumesHyperVParams :  IEquatable<MountVolumesHyperVParams>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as MountVolumesHyperVParams);
        }

        /// <summary>
        /// Returns true if MountVolumesHyperVParams instances are equal
        /// </summary>
        /// <param name="input">Instance of MountVolumesHyperVParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MountVolumesHyperVParams input)
        {
            if (input == null)
                return false;
