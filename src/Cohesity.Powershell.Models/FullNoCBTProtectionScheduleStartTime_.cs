...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class FullNoCBTProtectionScheduleStartTime_ :  IEquatable<FullNoCBTProtectionScheduleStartTime_>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FullNoCBTProtectionScheduleStartTime_" /> class.
        /// </summary>
        /// <param name="hour">Specifies an (0-23) hour in a day..</param>
        /// <param name="minute">Specifies a (0-59) minute in an hour..</param>
        public FullNoCBTProtectionScheduleStartTime_(int? hour = default(int?), int? minute = default(int?))
        {
            this.Hour = hour;
            this.Minute = minute;
        }
        ...
        //    sb.Append("class FullNoCBTProtectionScheduleStartTime_ {\n");
        ...
        {
            return this.Equals(input as FullNoCBTProtectionScheduleStartTime_);
        }

        /// <summary>
        /// Returns true if FullNoCBTProtectionScheduleStartTime_ instances are equal
        /// </summary>
        /// <param name="input">Instance of FullNoCBTProtectionScheduleStartTime_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FullNoCBTProtectionScheduleStartTime_ input)
        {
            if (input == null)
                return false;
