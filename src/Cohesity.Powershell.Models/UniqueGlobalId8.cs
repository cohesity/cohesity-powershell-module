...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class UniqueGlobalId8 :  IEquatable<UniqueGlobalId8>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniqueGlobalId8" /> class.
        /// </summary>
        ...
        public UniqueGlobalId8(long? clusterId = default(long?), long? clusterIncarnationId = default(long?), long? id = default(long?))
        {
        ...
        {
            return this.Equals(input as UniqueGlobalId8);
        }

        /// <summary>
        /// Returns true if UniqueGlobalId8 instances are equal
        /// </summary>
        /// <param name="input">Instance of UniqueGlobalId8 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniqueGlobalId8 input)
        {
            if (input == null)
                return false;
