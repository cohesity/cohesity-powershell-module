...
namespace Cohesity.Model
{
    ...
    public partial class RansomwareInfo :  IEquatable<RansomwareInfo>
    {
        ...
        public RansomwareInfo(string endDate = default(string), bool? isActive = default(bool?), bool? isFreeTrial = default(bool?), long? quantity = default(long?), string startDate = default(string))
        {
