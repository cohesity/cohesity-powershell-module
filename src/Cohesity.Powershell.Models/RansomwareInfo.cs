...
namespace Cohesity.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RansomwareInfo" /> class.
        /// </summary>
        /// <param name="banner">banner.</param>
        /// <param name="endDate">Specifies the end date of the subscription..</param>
        /// <param name="isActive">Specifies whether the RPaaS subscription is active..</param>
        ...
        public RansomwareInfo(EntitlementBannerInfo banner = default(EntitlementBannerInfo), string endDate = default(string), bool? isActive = default(bool?), bool? isFreeTrial = default(bool?), string productDisplayName = default(string), long? quantity = default(long?), string startDate = default(string))
        {
        ...
        /// </summary>
        /// <value>Specifies whether the RPaaS subscription is active.</value>
        ...
        {
            return this.Equals(input as RansomwareInfo);
        }

        /// <summary>
        /// Returns true if RansomwareInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of RansomwareInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RansomwareInfo input)
        {
            if (input == null)
                return false;
