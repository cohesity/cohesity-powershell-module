...
namespace Cohesity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TenantProtectionJobUpdate :  IEquatable<TenantProtectionJobUpdate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TenantProtectionJobUpdate" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TenantProtectionJobUpdate {\n");
        ...
        {
            return this.Equals(input as TenantProtectionJobUpdate);
        }

        /// <summary>
        /// Returns true if TenantProtectionJobUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of TenantProtectionJobUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TenantProtectionJobUpdate input)
        {
            if (input == null)
                return false;
