...
namespace Cohesity.Model
{
    ...
    public partial class PhysicalParams :  IEquatable<PhysicalParams>
    {
        ...
        public PhysicalParams(List<ApplicationsEnum> applications = default(List<ApplicationsEnum>), string password = default(string), SourceThrottlingConfiguration throttlingConfig = default(SourceThrottlingConfiguration), string username = default(string))
        {
