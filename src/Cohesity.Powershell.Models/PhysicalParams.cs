...
{
    /// <summary>
    /// Specifies the parameters required to register Application Servers running in a Protection Source specific to a physical adapter.
    /// </summary>
    [DataContract]
    public partial class PhysicalParams :  IEquatable<PhysicalParams>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PhysicalParams" /> class.
        /// </summary>
        ...
        public PhysicalParams(List<ApplicationsEnum> applications = default(List<ApplicationsEnum>), CloudCredentials cloudCredentials = default(CloudCredentials), string password = default(string), SourceThrottlingConfiguration throttlingConfig = default(SourceThrottlingConfiguration), string username = default(string))
        {
        ...
        public SourceThrottlingConfiguration ThrottlingConfig { get; set; }
        ...
        {
            return this.Equals(input as PhysicalParams);
        }

        /// <summary>
        /// Returns true if PhysicalParams instances are equal
        /// </summary>
        /// <param name="input">Instance of PhysicalParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PhysicalParams input)
        {
            if (input == null)
                return false;
