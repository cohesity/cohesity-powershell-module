...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class SearchJobUid1 :  IEquatable<SearchJobUid1>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchJobUid1" /> class.
        /// </summary>
        ...
        public SearchJobUid1(long? clusterId = default(long?), long? clusterIncarnationId = default(long?), long? id = default(long?))
        {
        ...
        {
            return this.Equals(input as SearchJobUid1);
        }

        /// <summary>
        /// Returns true if SearchJobUid1 instances are equal
        /// </summary>
        /// <param name="input">Instance of SearchJobUid1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SearchJobUid1 input)
        {
            if (input == null)
                return false;
