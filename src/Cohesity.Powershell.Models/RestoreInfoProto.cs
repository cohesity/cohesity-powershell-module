...
namespace Cohesity.Model
{
    ...
    public partial class RestoreInfoProto :  IEquatable<RestoreInfoProto>
    {
        ...
        public RestoreInfoProto(List<RestoreInfoProtoRestoreEntity> restoreEntityVec = default(List<RestoreInfoProtoRestoreEntity>), int? targetType = default(int?), int? type = default(int?))
        {
