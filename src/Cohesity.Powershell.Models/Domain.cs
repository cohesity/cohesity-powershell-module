...
namespace Cohesity.Model
{
    ...
    public partial class Domain :  IEquatable<Domain>
    {
        ...
        public Domain(string description = default(string), bool? enabled = default(bool?), string id = default(string), Links links = default(Links), string name = default(string))
        {
