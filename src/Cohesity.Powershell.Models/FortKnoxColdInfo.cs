...
namespace Cohesity.Model
{
    ...
    public partial class FortKnoxColdInfo :  IEquatable<FortKnoxColdInfo>
    {
        ...
        public FortKnoxColdInfo(EntitlementBannerInfo banner = default(EntitlementBannerInfo), string endDate = default(string), bool? isActive = default(bool?), bool? isFreeTrial = default(bool?), string productDisplayName = default(string), long? quantity = default(long?), string startDate = default(string))
        {
