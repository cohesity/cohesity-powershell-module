...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class BlackoutEndTime_ :  IEquatable<BlackoutEndTime_>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BlackoutEndTime_" /> class.
        /// </summary>
        /// <param name="hour">Specifies an (0-23) hour in a day..</param>
        /// <param name="minute">Specifies a (0-59) minute in an hour..</param>
        public BlackoutEndTime_(int? hour = default(int?), int? minute = default(int?))
        {
            this.Hour = hour;
            this.Minute = minute;
        }
        ...
        {
            return this.Equals(input as BlackoutEndTime_);
        }

        /// <summary>
        /// Returns true if BlackoutEndTime_ instances are equal
        /// </summary>
        /// <param name="input">Instance of BlackoutEndTime_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BlackoutEndTime_ input)
        {
            if (input == null)
                return false;
