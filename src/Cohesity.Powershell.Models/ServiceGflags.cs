...
namespace Cohesity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ServiceGflags :  IEquatable<ServiceGflags>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceGflags" /> class.
        /// </summary>
        /// <param name="gflags">Specifies a list of gflags for this service..</param>
        ...
        public ServiceGflags(List<Gflag> gflags = default(List<Gflag>), ServiceNameEnum? serviceName = default(ServiceNameEnum?))
        {
            this.Gflags = gflags;
        ...
        /// </summary>
        /// <value>Specifies a list of gflags for this service.</value>
        ...
        {
            return this.Equals(input as ServiceGflags);
        }

        /// <summary>
        /// Returns true if ServiceGflags instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceGflags to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceGflags input)
        {
            if (input == null)
                return false;
