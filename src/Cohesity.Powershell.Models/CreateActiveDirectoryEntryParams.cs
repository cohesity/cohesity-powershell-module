...
namespace Cohesity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateActiveDirectoryEntryParams :  IEquatable<CreateActiveDirectoryEntryParams>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateActiveDirectoryEntryParams" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CreateActiveDirectoryEntryParams);
        }

        /// <summary>
        /// Returns true if CreateActiveDirectoryEntryParams instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateActiveDirectoryEntryParams to be compared</param>
        /// <returns>Boolean</returns>
