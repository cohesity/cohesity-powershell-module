...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class UniqueGlobalId10 :  IEquatable<UniqueGlobalId10>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniqueGlobalId10" /> class.
        /// </summary>
        ...
        public UniqueGlobalId10(long? clusterId = default(long?), long? clusterIncarnationId = default(long?), long? id = default(long?))
        {
        ...
        {
            return this.Equals(input as UniqueGlobalId10);
        }

        /// <summary>
        /// Returns true if UniqueGlobalId10 instances are equal
        /// </summary>
        /// <param name="input">Instance of UniqueGlobalId10 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniqueGlobalId10 input)
        {
            if (input == null)
                return false;
