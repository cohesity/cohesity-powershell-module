...
namespace Cohesity.Model
{
    ...
    public partial class Disk :  IEquatable<Disk>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DiskBlocks: ").Append(DiskBlocks).Append("\n");
            sb.Append("  DiskFormat: ").Append(DiskFormat).Append("\n");
            sb.Append("  DiskPartitions: ").Append(DiskPartitions).Append("\n");
            sb.Append("  PartitionTableFormat: ").Append(PartitionTableFormat).Append("\n");
            sb.Append("  SectorSizeBytes: ").Append(SectorSizeBytes).Append("\n");
            sb.Append("  Uuid: ").Append(Uuid).Append("\n");
            sb.Append("  VmdkFileName: ").Append(VmdkFileName).Append("\n");
            sb.Append("  VmdkSizeBytes: ").Append(VmdkSizeBytes).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
