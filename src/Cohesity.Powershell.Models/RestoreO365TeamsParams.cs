...
namespace Cohesity.Model
{
    ...
    public partial class RestoreO365TeamsParams :  IEquatable<RestoreO365TeamsParams>
    {
        ...
        public RestoreO365TeamsParams(bool? createNewTeam = default(bool?), List<RestoreO365TeamsParamsMSTeamInfo> msTeamsVec = default(List<RestoreO365TeamsParamsMSTeamInfo>), bool? restoreOriginalOwnersMembers = default(bool?), bool? restoreToOriginal = default(bool?), EntityProto targetMsTeamEntity = default(EntityProto), string targetTeam = default(string), string targetTeamName = default(string), string targetTeamOwner = default(string), EntityProto targetTeamOwnerEntity = default(EntityProto))
        {
        ...
        [DataMember(Name="createNewTeam", EmitDefaultValue=false)]
        ...
        [DataMember(Name="msTeamsVec", EmitDefaultValue=false)]
        ...
        [DataMember(Name="targetTeamName", EmitDefaultValue=false)]
        ...
        [DataMember(Name="targetTeamOwner", EmitDefaultValue=false)]
