...
namespace Cohesity.Model
{
    ...
    public partial class ProtectionJobRequestBody :  IEquatable<ProtectionJobRequestBody>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProtectionJobRequestBody {\n");
