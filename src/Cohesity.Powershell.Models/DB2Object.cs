...
namespace Cohesity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DB2Object :  IEquatable<DB2Object>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DB2Object" /> class.
        /// </summary>
        /// <param name="isLeaf">Indicates whether this object is is a leaf object.</param>
        /// <param name="objectType">Type of this object.</param>
        public DB2Object(bool? isLeaf = default(bool?), string objectType = default(string))
        {
            this.IsLeaf = isLeaf;
        ...
        {
            return this.Equals(input as DB2Object);
        }

        /// <summary>
        /// Returns true if DB2Object instances are equal
        /// </summary>
        /// <param name="input">Instance of DB2Object to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DB2Object input)
        {
            if (input == null)
                return false;
