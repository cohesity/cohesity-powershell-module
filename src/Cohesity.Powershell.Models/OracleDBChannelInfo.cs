...
namespace Cohesity.Model
{
    ...
    public partial class OracleDBChannelInfo :  IEquatable<OracleDBChannelInfo>
    {
        ...
        /// <param name="dgRoleBasedBackup">dgRoleBasedBackup.</param>
        ...
        public OracleDBChannelInfo(int? archivelogKeepDays = default(int?), int? archivelogKeepHours = default(int?), Credentials credentials = default(Credentials), string dbUniqueName = default(string), string dbUuid = default(string), OracleDBChannelInfoDgRoleBasedBackup dgRoleBasedBackup = default(OracleDBChannelInfoDgRoleBasedBackup), bool? enableDgPrimaryBackup = default(bool?), List<OracleDBChannelInfoHostInfo> hostInfoVec = default(List<OracleDBChannelInfoHostInfo>), int? maxNumHost = default(int?), int? numChannels = default(int?), int? rmanBackupType = default(int?))
        {
            ...
            this.DbUniqueName = dbUniqueName;
            this.DbUuid = dbUuid;
            this.DgRoleBasedBackup = dgRoleBasedBackup;
            this.EnableDgPrimaryBackup = enableDgPrimaryBackup;
            this.HostInfoVec = hostInfoVec;
            this.MaxNumHost = maxNumHost;
            this.NumChannels = numChannels;
        ...
        /// <summary>
        /// Gets or Sets DgRoleBasedBackup
        /// </summary>
        [DataMember(Name="dgRoleBasedBackup", EmitDefaultValue=false)]
        public OracleDBChannelInfoDgRoleBasedBackup DgRoleBasedBackup { get; set; }
        ...
        public bool Equals(OracleDBChannelInfo input)
        {
            ...
            return 
                ...
                (
                    this.DgRoleBasedBackup == input.DgRoleBasedBackup ||
                    (this.DgRoleBasedBackup != null &&
                    this.DgRoleBasedBackup.Equals(input.DgRoleBasedBackup))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DgRoleBasedBackup != null)
                    hashCode = hashCode * 59 + this.DgRoleBasedBackup.GetHashCode();
