...
namespace Cohesity.Model
{
    ...
    public partial class DataProtectAzureInfo :  IEquatable<DataProtectAzureInfo>
    {
        ...
        public DataProtectAzureInfo(string endDate = default(string), bool? isActive = default(bool?), bool? isFreeTrial = default(bool?), long? quantity = default(long?), string startDate = default(string), TieringInfo tiering = default(TieringInfo))
        {
