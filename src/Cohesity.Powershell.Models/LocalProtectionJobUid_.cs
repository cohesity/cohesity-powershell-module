...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class LocalProtectionJobUid_ :  IEquatable<LocalProtectionJobUid_>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LocalProtectionJobUid_" /> class.
        /// </summary>
        ...
        public LocalProtectionJobUid_(long? clusterId = default(long?), long? clusterIncarnationId = default(long?), long? id = default(long?))
        {
        ...
        {
            return this.Equals(input as LocalProtectionJobUid_);
        }

        /// <summary>
        /// Returns true if LocalProtectionJobUid_ instances are equal
        /// </summary>
        /// <param name="input">Instance of LocalProtectionJobUid_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LocalProtectionJobUid_ input)
        {
            if (input == null)
                return false;
