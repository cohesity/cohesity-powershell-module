...
namespace Cohesity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AwsFleetPublicParams :  IEquatable<AwsFleetPublicParams>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AwsFleetPublicParams" /> class.
        /// </summary>
        ...
        public AwsFleetPublicParams(FleetSubnetTypeEnum? fleetSubnetType = default(FleetSubnetTypeEnum?), List<FleetTag> fleetTags = default(List<FleetTag>), List<FleetNetworkParams> networkParamsList = default(List<FleetNetworkParams>))
        {
        ...
        {
            return this.Equals(input as AwsFleetPublicParams);
        }

        /// <summary>
        /// Returns true if AwsFleetPublicParams instances are equal
        /// </summary>
        /// <param name="input">Instance of AwsFleetPublicParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AwsFleetPublicParams input)
        {
            if (input == null)
                return false;
