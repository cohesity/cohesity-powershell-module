...
namespace Cohesity.Models
{
    ...
    public partial class VmwareCloneParameters :  IEquatable<VmwareCloneParameters>
    {
        ...
        public VmwareCloneParameters(long? datastoreFolderId = default(long?), bool? disableNetwork = default(bool?), long? networkId = default(long?), bool? poweredOn = default(bool?), string prefix = default(string), long? resourcePoolId = default(long?), string suffix = default(string), long? vmFolderId = default(long?))
        {
