...
namespace Cohesity.Model
{
    ...
    public partial class OutlookRestoreParameters :  IEquatable<OutlookRestoreParameters>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OutlookRestoreParameters {\n");
            sb.Append("  OutlookMailboxList: ").Append(OutlookMailboxList).Append("\n");
            sb.Append("  TargetFolderPath: ").Append(TargetFolderPath).Append("\n");
            sb.Append("  TargetMailbox: ").Append(TargetMailbox).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
