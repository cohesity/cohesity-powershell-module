...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class RegisteredSourceInfo_ :  IEquatable<RegisteredSourceInfo_>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RegisteredSourceInfo_" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as RegisteredSourceInfo_);
        }

        /// <summary>
        /// Returns true if RegisteredSourceInfo_ instances are equal
        /// </summary>
        /// <param name="input">Instance of RegisteredSourceInfo_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RegisteredSourceInfo_ input)
        {
            if (input == null)
                return false;
