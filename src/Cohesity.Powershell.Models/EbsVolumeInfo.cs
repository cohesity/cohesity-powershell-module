...
namespace Cohesity.Model
{
    ...
    public partial class EbsVolumeInfo :  IEquatable<EbsVolumeInfo>
    {
        ...
        public EbsVolumeInfo(string deviceName = default(string), string id = default(string), bool? isRootDevice = default(bool?), string name = default(string), long? sizeBytes = default(long?), string type = default(string))
        {
        ...
        [DataMember(Name="isRootDevice", EmitDefaultValue=false)]
