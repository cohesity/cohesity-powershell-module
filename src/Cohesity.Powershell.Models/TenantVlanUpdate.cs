...
namespace Cohesity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TenantVlanUpdate :  IEquatable<TenantVlanUpdate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TenantVlanUpdate" /> class.
        /// </summary>
        ...
        public TenantVlanUpdate(string tenantId = default(string), List<string> vlanIfaceNames = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TenantVlanUpdate {\n");
        ...
        {
            return this.Equals(input as TenantVlanUpdate);
        }

        /// <summary>
        /// Returns true if TenantVlanUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of TenantVlanUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TenantVlanUpdate input)
        {
            if (input == null)
                return false;
