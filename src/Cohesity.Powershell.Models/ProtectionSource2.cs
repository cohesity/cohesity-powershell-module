...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProtectionSource2 :  IEquatable<ProtectionSource2>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProtectionSource2" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ProtectionSource2);
        }

        /// <summary>
        /// Returns true if ProtectionSource2 instances are equal
        /// </summary>
        /// <param name="input">Instance of ProtectionSource2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProtectionSource2 input)
        {
            if (input == null)
                return false;
