...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class CBTbasedJobPolicy_ :  IEquatable<CBTbasedJobPolicy_>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CBTbasedJobPolicy_);
        }

        /// <summary>
        /// Returns true if CBTbasedJobPolicy_ instances are equal
        /// </summary>
        /// <param name="input">Instance of CBTbasedJobPolicy_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CBTbasedJobPolicy_ input)
        {
            if (input == null)
                return false;
