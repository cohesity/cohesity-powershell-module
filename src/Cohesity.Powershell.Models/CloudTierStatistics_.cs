...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class CloudTierStatistics_ :  IEquatable<CloudTierStatistics_>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CloudTierStatistics_" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CloudTierStatistics_);
        }

        /// <summary>
        /// Returns true if CloudTierStatistics_ instances are equal
        /// </summary>
        /// <param name="input">Instance of CloudTierStatistics_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CloudTierStatistics_ input)
        {
            if (input == null)
                return false;
