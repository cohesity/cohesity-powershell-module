...
namespace Cohesity.Models
{
    ...
    public partial class ProtectionPolicy :  IEquatable<ProtectionPolicy>
    {
        ...
        public ProtectionPolicy(List<BlackoutPeriod> blackoutPeriods = default(List<BlackoutPeriod>), List<SnapshotCloudCopyPolicy> cloudDeployPolicies = default(List<SnapshotCloudCopyPolicy>), long? daysToKeep = default(long?), long? daysToKeepLog = default(long?), long? daysToKeepSystem = default(long?), string description = default(string), List<ExtendedRetentionPolicy> extendedRetentionPolicies = default(List<ExtendedRetentionPolicy>), FullNoCBTJobPolicy_ fullSchedulingPolicy = default(FullNoCBTJobPolicy_), string id = default(string), CBTbasedJobPolicy_ incrementalSchedulingPolicy = default(CBTbasedJobPolicy_), long? lastModifiedTimeMsecs = default(long?), SchedulingPolicy logSchedulingPolicy = default(SchedulingPolicy), string name = default(string), int? retries = default(int?), int? retryIntervalMins = default(int?), int? skipIntervalMins = default(int?), List<SnapshotArchivalCopyPolicy> snapshotArchivalCopyPolicies = default(List<SnapshotArchivalCopyPolicy>), List<SnapshotReplicationCopyPolicy> snapshotReplicationCopyPolicies = default(List<SnapshotReplicationCopyPolicy>), SchedulingPolicy systemSchedulingPolicy = default(SchedulingPolicy))
        {
        ...
        [DataMember(Name="lastModifiedTimeMsecs", EmitDefaultValue=false)]
