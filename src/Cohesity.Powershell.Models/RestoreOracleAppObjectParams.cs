...
namespace Cohesity.Model
{
    ...
    public partial class RestoreOracleAppObjectParams :  IEquatable<RestoreOracleAppObjectParams>
    {
        ...
        /// <param name="restoreAsRac">Specifies whether it is restored to a RAC database..</param>
        ...
        /// <param name="sameConfigIrRecoveryOptions">sameConfigIrRecoveryOptions.</param>
        ...
        public RestoreOracleAppObjectParams(RestoreOracleAppObjectParamsAlternateLocationParams alternateLocationParams = default(RestoreOracleAppObjectParamsAlternateLocationParams), bool? attemptCompleteRecovery = default(bool?), GranularRestoreInfo granularRestoreInfo = default(GranularRestoreInfo), bool? isMultiStageRestore = default(bool?), NFSParams nfsParams = default(NFSParams), bool? noOpenMode = default(bool?), OracleArchiveLogInfo oracleArchiveLogRestoreInfo = default(OracleArchiveLogInfo), List<CloneAppViewParams> oracleCloneAppViewParamsVec = default(List<CloneAppViewParams>), OracleRecoveryValidationInfo oracleRecoveryValidationInfo = default(OracleRecoveryValidationInfo), OracleSourceParams oracleTargetParams = default(OracleSourceParams), OracleUpdateRestoreTaskOptions oracleUpdateRestoreOptions = default(OracleUpdateRestoreTaskOptions), bool? parallelOpEnabled = default(bool?), bool? restoreAsRac = default(bool?), RestoreSpfileOrPfileInfo restoreSpfileOrPfileInfo = default(RestoreSpfileOrPfileInfo), long? restoreTimeSecs = default(long?), List<string> rollForwardLogPathVec = default(List<string>), long? rollForwardTimeMsecs = default(long?), SameConfigIrRecoveryOptions sameConfigIrRecoveryOptions = default(SameConfigIrRecoveryOptions), List<RestoreOracleAppObjectParamsKeyValuePair> shellEnvironmentVec = default(List<RestoreOracleAppObjectParamsKeyValuePair>), bool? skipCloneNid = default(bool?), bool? stopActivePassive = default(bool?), bool? useScnForRestore = default(bool?))
        {
            ...
            this.RestoreAsRac = restoreAsRac;
            ...
            this.RollForwardLogPathVec = rollForwardLogPathVec;
            this.RollForwardTimeMsecs = rollForwardTimeMsecs;
            this.SameConfigIrRecoveryOptions = sameConfigIrRecoveryOptions;
            this.ShellEnvironmentVec = shellEnvironmentVec;
            this.SkipCloneNid = skipCloneNid;
            this.StopActivePassive = stopActivePassive;
            this.UseScnForRestore = useScnForRestore;
        ...
        /// </summary>
        /// <value>Specifies whether it is restored to a RAC database.</value>
        [DataMember(Name="restoreAsRac", EmitDefaultValue=true)]
        public bool? RestoreAsRac { get; set; }
        ...
        /// <summary>
        /// Gets or Sets SameConfigIrRecoveryOptions
        /// </summary>
        [DataMember(Name="sameConfigIrRecoveryOptions", EmitDefaultValue=false)]
        public SameConfigIrRecoveryOptions SameConfigIrRecoveryOptions { get; set; }
        ...
        public bool Equals(RestoreOracleAppObjectParams input)
        {
            ...
            return 
                ...
                (
                    this.RestoreAsRac == input.RestoreAsRac ||
                    (this.RestoreAsRac != null &&
                    this.RestoreAsRac.Equals(input.RestoreAsRac))
                ) && 
                (
                ...
                (
                    this.SameConfigIrRecoveryOptions == input.SameConfigIrRecoveryOptions ||
                    (this.SameConfigIrRecoveryOptions != null &&
                    this.SameConfigIrRecoveryOptions.Equals(input.SameConfigIrRecoveryOptions))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RestoreAsRac != null)
                    hashCode = hashCode * 59 + this.RestoreAsRac.GetHashCode();
                ...
                if (this.SameConfigIrRecoveryOptions != null)
                    hashCode = hashCode * 59 + this.SameConfigIrRecoveryOptions.GetHashCode();
