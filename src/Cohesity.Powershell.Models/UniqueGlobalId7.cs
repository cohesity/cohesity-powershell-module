...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class UniqueGlobalId7 :  IEquatable<UniqueGlobalId7>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniqueGlobalId7" /> class.
        /// </summary>
        ...
        public UniqueGlobalId7(long? clusterId = default(long?), long? clusterIncarnationId = default(long?), long? id = default(long?))
        {
        ...
        {
            return this.Equals(input as UniqueGlobalId7);
        }

        /// <summary>
        /// Returns true if UniqueGlobalId7 instances are equal
        /// </summary>
        /// <param name="input">Instance of UniqueGlobalId7 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniqueGlobalId7 input)
        {
            if (input == null)
                return false;
