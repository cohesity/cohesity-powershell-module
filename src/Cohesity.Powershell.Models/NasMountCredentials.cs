...
namespace Cohesity.Models
{
    ...
    public partial class NasMountCredentials :  IEquatable<NasMountCredentials>
    {
        ...
        public NasMountCredentials(string domain = default(string), NasProtocolEnum? nasProtocol = default(NasProtocolEnum?), string password = default(string), string username = default(string))
        {
            this.Domain = domain;
