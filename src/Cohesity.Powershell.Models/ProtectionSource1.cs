...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProtectionSource1 :  IEquatable<ProtectionSource1>
    {
        ...
        {
            return this.Equals(input as ProtectionSource1);
        }

        /// <summary>
        /// Returns true if ProtectionSource1 instances are equal
        /// </summary>
        /// <param name="input">Instance of ProtectionSource1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProtectionSource1 input)
        {
            if (input == null)
                return false;
