...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class SearchJobId_ :  IEquatable<SearchJobId_>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchJobId_" /> class.
        /// </summary>
        ...
        public SearchJobId_(long? clusterId = default(long?), long? clusterIncarnationId = default(long?), long? id = default(long?))
        {
        ...
        {
            return this.Equals(input as SearchJobId_);
        }

        /// <summary>
        /// Returns true if SearchJobId_ instances are equal
        /// </summary>
        /// <param name="input">Instance of SearchJobId_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SearchJobId_ input)
        {
            if (input == null)
                return false;
