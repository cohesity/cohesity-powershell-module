...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class IndexingTaskUid_ :  IEquatable<IndexingTaskUid_>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IndexingTaskUid_" /> class.
        /// </summary>
        ...
        public IndexingTaskUid_(long? clusterId = default(long?), long? clusterIncarnationId = default(long?), long? id = default(long?))
        {
        ...
        {
            return this.Equals(input as IndexingTaskUid_);
        }

        /// <summary>
        /// Returns true if IndexingTaskUid_ instances are equal
        /// </summary>
        /// <param name="input">Instance of IndexingTaskUid_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IndexingTaskUid_ input)
        {
            if (input == null)
                return false;
