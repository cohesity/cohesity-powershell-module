...
namespace Cohesity.Model
{
    ...
    public partial class ConnectorParameters :  IEquatable<ConnectorParameters>
    {
        ...
        public ConnectorParameters(string endpoint = default(string), EnvironmentEnum? environment = default(EnvironmentEnum?), long? id = default(long?), long? version = default(long?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConnectorParameters {\n");
