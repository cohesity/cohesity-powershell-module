...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ParentJobUid_ :  IEquatable<ParentJobUid_>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ParentJobUid_" /> class.
        /// </summary>
        ...
        public ParentJobUid_(long? clusterId = default(long?), long? clusterIncarnationId = default(long?), long? id = default(long?))
        {
        ...
        {
            return this.Equals(input as ParentJobUid_);
        }

        /// <summary>
        /// Returns true if ParentJobUid_ instances are equal
        /// </summary>
        /// <param name="input">Instance of ParentJobUid_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ParentJobUid_ input)
        {
            if (input == null)
                return false;
