...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class Subnet_ :  IEquatable<Subnet_>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Subnet_" /> class.
        /// </summary>
        ...
        public Subnet_(string description = default(string), string ip = default(string), int? netmaskBits = default(int?), string netmaskIp4 = default(string))
        {
        ...
        {
            return this.Equals(input as Subnet_);
        }

        /// <summary>
        /// Returns true if Subnet_ instances are equal
        /// </summary>
        /// <param name="input">Instance of Subnet_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Subnet_ input)
        {
            if (input == null)
                return false;
