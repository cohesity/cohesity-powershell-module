...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class CBTbasedScript_ :  IEquatable<CBTbasedScript_>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CBTbasedScript_" /> class.
        /// </summary>
        ...
        public CBTbasedScript_(string scriptParams = default(string), string scriptPath = default(string))
        {
        ...
        {
            return this.Equals(input as CBTbasedScript_);
        }

        /// <summary>
        /// Returns true if CBTbasedScript_ instances are equal
        /// </summary>
        /// <param name="input">Instance of CBTbasedScript_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CBTbasedScript_ input)
        {
            if (input == null)
                return false;
