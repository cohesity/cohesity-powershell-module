...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ArchivalTarget_ :  IEquatable<ArchivalTarget_>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ArchivalTarget_" /> class.
        /// </summary>
        ...
        public ArchivalTarget_(long? vaultId = default(long?), string vaultName = default(string), VaultTypeEnum? vaultType = default(VaultTypeEnum?))
        {
        ...
        {
            return this.Equals(input as ArchivalTarget_);
        }

        /// <summary>
        /// Returns true if ArchivalTarget_ instances are equal
        /// </summary>
        /// <param name="input">Instance of ArchivalTarget_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArchivalTarget_ input)
        {
            if (input == null)
                return false;
