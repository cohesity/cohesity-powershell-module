...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProtectionSource4 :  IEquatable<ProtectionSource4>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProtectionSource4" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ProtectionSource4);
        }

        /// <summary>
        /// Returns true if ProtectionSource4 instances are equal
        /// </summary>
        /// <param name="input">Instance of ProtectionSource4 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProtectionSource4 input)
        {
            if (input == null)
                return false;
