...
namespace Cohesity.Model
{
    ...
    public partial class UdaBackupJobParams :  IEquatable<UdaBackupJobParams>
    {
        ...
        public UdaBackupJobParams(int? concurrency = default(int?), string fullBackupArgs = default(string), string incrementalBackupArgs = default(string), string logBackupArgs = default(string), int? mounts = default(int?), long? sourceId = default(long?), List<UdaObjects> udaObjects = default(List<UdaObjects>), UdaS3ViewBackupProperties udaS3ViewBackupProperties = default(UdaS3ViewBackupProperties))
        {
        ...
        [DataMember(Name="fullBackupArgs", EmitDefaultValue=false)]
        ...
        [DataMember(Name="incrementalBackupArgs", EmitDefaultValue=false)]
        ...
        [DataMember(Name="logBackupArgs", EmitDefaultValue=false)]
        ...
        [DataMember(Name="udaObjects", EmitDefaultValue=false)]
