...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProtectionSummaryInformationOfARegisteredProtectionSourceTreeOrtheCohesityCluster_ :  IEquatable<ProtectionSummaryInformationOfARegisteredProtectionSourceTreeOrtheCohesityCluster_>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProtectionSummaryInformationOfARegisteredProtectionSourceTreeOrtheCohesityCluster_" /> class.
        /// </summary>
        ...
        public ProtectionSummaryInformationOfARegisteredProtectionSourceTreeOrtheCohesityCluster_(long? protectedCount = default(long?), long? protectedSize = default(long?), long? unprotectedCount = default(long?), long? unprotectedSize = default(long?))
        {
        ...
        {
            return this.Equals(input as ProtectionSummaryInformationOfARegisteredProtectionSourceTreeOrtheCohesityCluster_);
        }

        /// <summary>
        /// Returns true if ProtectionSummaryInformationOfARegisteredProtectionSourceTreeOrtheCohesityCluster_ instances are equal
        /// </summary>
        /// <param name="input">Instance of ProtectionSummaryInformationOfARegisteredProtectionSourceTreeOrtheCohesityCluster_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProtectionSummaryInformationOfARegisteredProtectionSourceTreeOrtheCohesityCluster_ input)
        {
            if (input == null)
                return false;
