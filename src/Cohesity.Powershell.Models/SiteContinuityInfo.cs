...
{
    /// <summary>
    /// SiteContinuityInfo holds information about the Site Continuity subscription such as if it is active or not.
    /// </summary>
    [DataContract]
    public partial class SiteContinuityInfo :  IEquatable<SiteContinuityInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SiteContinuityInfo" /> class.
        /// </summary>
        /// <param name="banner">banner.</param>
        /// <param name="endDate">Specifies the end date of the subscription..</param>
        /// <param name="isActive">Specifies whether the DRaaS subscription is active..</param>
        ...
        public SiteContinuityInfo(EntitlementBannerInfo banner = default(EntitlementBannerInfo), string endDate = default(string), bool? isActive = default(bool?), bool? isFreeTrial = default(bool?), string productDisplayName = default(string), string startDate = default(string))
        {
        ...
        /// </summary>
        /// <value>Specifies whether the DRaaS subscription is active.</value>
        ...
        {
            return this.Equals(input as SiteContinuityInfo);
        }

        /// <summary>
        /// Returns true if SiteContinuityInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of SiteContinuityInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SiteContinuityInfo input)
        {
            if (input == null)
                return false;
