...
{
    /// <summary>
    /// ClassificationInfo holds information about the Datahawk Classification subscription such as if it is active or not.
    /// </summary>
    [DataContract]
    public partial class ClassificationInfo :  IEquatable<ClassificationInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClassificationInfo" /> class.
        /// </summary>
        /// <param name="banner">banner.</param>
        /// <param name="endDate">Specifies the end date of the subscription..</param>
        /// <param name="isActive">Specifies whether the Datahawk Classification subscription is active..</param>
        ...
        public ClassificationInfo(EntitlementBannerInfo banner = default(EntitlementBannerInfo), string endDate = default(string), bool? isActive = default(bool?), bool? isFreeTrial = default(bool?), string productDisplayName = default(string), string startDate = default(string))
        {
        ...
        /// </summary>
        /// <value>Specifies whether the Datahawk Classification subscription is active.</value>
        ...
        {
            return this.Equals(input as ClassificationInfo);
        }

        /// <summary>
        /// Returns true if ClassificationInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ClassificationInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClassificationInfo input)
        {
            if (input == null)
                return false;
