...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class AWSProtectionSource_ :  IEquatable<AWSProtectionSource_>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AWSProtectionSource_" /> class.
        /// </summary>
        ...
        public AWSProtectionSource_(HostTypeEnum? hostType = default(HostTypeEnum?), string ipAddresses = default(string), string name = default(string), string ownerId = default(string), string regionId = default(string), string resourceId = default(string), TypeEnum? type = default(TypeEnum?), string userAccountId = default(string), string userResourceName = default(string))
        {
        ...
        {
            return this.Equals(input as AWSProtectionSource_);
        }

        /// <summary>
        /// Returns true if AWSProtectionSource_ instances are equal
        /// </summary>
        /// <param name="input">Instance of AWSProtectionSource_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AWSProtectionSource_ input)
        {
            if (input == null)
                return false;
