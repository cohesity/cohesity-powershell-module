...
namespace Cohesity.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BackupPolicyProtoExclusionTimeRange" /> class.
        /// </summary>
        /// <param name="day">If the day is not set, the time range applies to all days..</param>
        /// <param name="endTime">endTime.</param>
        /// <param name="startTime">startTime.</param>
        public BackupPolicyProtoExclusionTimeRange(int? day = default(int?), Time endTime = default(Time), Time startTime = default(Time))
        {
            this.Day = day;
            this.Day = day;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BackupPolicyProtoExclusionTimeRange {\n");
        ...
        {
            return this.Equals(input as BackupPolicyProtoExclusionTimeRange);
        }

        /// <summary>
        /// Returns true if BackupPolicyProtoExclusionTimeRange instances are equal
        /// </summary>
        /// <param name="input">Instance of BackupPolicyProtoExclusionTimeRange to be compared</param>
        /// <returns>Boolean</returns>
