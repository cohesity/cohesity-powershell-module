...
namespace Cohesity.Model
{
    ...
    public partial class NasBackupParams :  IEquatable<NasBackupParams>
    {
        ...
        public NasBackupParams(bool? backupExistingSnapshot = default(bool?), List<string> blacklistedIpAddrs = default(List<string>), bool? continueOnError = default(bool?), bool? encryptionEnabled = default(bool?), FilteringPolicyProto filteringPolicy = default(FilteringPolicyProto), ViewIdMappingProtoFileLevelDataLockConfig fldConfig = default(ViewIdMappingProtoFileLevelDataLockConfig), string fullBackupSnapshotLabel = default(string), string incrementalBackupSnapshotLabel = default(string), bool? isSourceInitiatedBackup = default(bool?), int? mixedModePreference = default(int?), int? nfsVersionPreference = default(int?), S3ViewBackupProperties s3Viewbackupproperties = default(S3ViewBackupProperties), bool? snapshotChangeEnabled = default(bool?), NasThrottlingParams throttlingParams = default(NasThrottlingParams), List<string> whitelistedIpAddrs = default(List<string>))
        {
        ...
        [DataMember(Name="backupExistingSnapshot", EmitDefaultValue=false)]
        ...
        [DataMember(Name="fullBackupSnapshotLabel", EmitDefaultValue=false)]
        ...
        [DataMember(Name="incrementalBackupSnapshotLabel", EmitDefaultValue=false)]
        ...
        [DataMember(Name="isSourceInitiatedBackup", EmitDefaultValue=false)]
        ...
        [DataMember(Name="mixedModePreference", EmitDefaultValue=false)]
        ...
        [DataMember(Name="nfsVersionPreference", EmitDefaultValue=false)]
        ...
        [DataMember(Name="snapshotChangeEnabled", EmitDefaultValue=false)]
