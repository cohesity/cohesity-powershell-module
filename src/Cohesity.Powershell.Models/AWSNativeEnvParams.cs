...
namespace Cohesity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AWSNativeEnvParams :  IEquatable<AWSNativeEnvParams>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AWSNativeEnvParams" /> class.
        /// </summary>
        /// <param name="volumeExclusionParams">volumeExclusionParams.</param>
        public AWSNativeEnvParams(EBSVolumeExclusionParams volumeExclusionParams = default(EBSVolumeExclusionParams))
        {
        ...
        {
            return this.Equals(input as AWSNativeEnvParams);
        }

        /// <summary>
        /// Returns true if AWSNativeEnvParams instances are equal
        /// </summary>
        /// <param name="input">Instance of AWSNativeEnvParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AWSNativeEnvParams input)
        {
            if (input == null)
                return false;
