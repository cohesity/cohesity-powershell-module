...
namespace Cohesity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RestoreSiteParamsDriveItem :  IEquatable<RestoreSiteParamsDriveItem>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RestoreSiteParamsDriveItem" /> class.
        /// </summary>
        ...
        public RestoreSiteParamsDriveItem(string driveItemPath = default(string), string id = default(string), bool? isFileItem = default(bool?))
        {
        ...
        {
            return this.Equals(input as RestoreSiteParamsDriveItem);
        }

        /// <summary>
        /// Returns true if RestoreSiteParamsDriveItem instances are equal
        /// </summary>
        /// <param name="input">Instance of RestoreSiteParamsDriveItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RestoreSiteParamsDriveItem input)
        {
            if (input == null)
                return false;
