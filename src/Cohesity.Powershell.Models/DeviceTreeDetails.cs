...
namespace Cohesity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeviceTreeDetails :  IEquatable<DeviceTreeDetails>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DeviceTreeDetails);
        }

        /// <summary>
        /// Returns true if DeviceTreeDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceTreeDetails to be compared</param>
        /// <returns>Boolean</returns>
