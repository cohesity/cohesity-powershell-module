...
namespace Cohesity.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TenantActiveDirectoryUpdateParameters :  IEquatable<TenantActiveDirectoryUpdateParameters>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TenantActiveDirectoryUpdateParameters" /> class.
        /// </summary>
        ...
        public TenantActiveDirectoryUpdateParameters(List<string> activeDirectoryDomains = default(List<string>), string tenantId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TenantActiveDirectoryUpdateParameters {\n");
        ...
        {
            return this.Equals(input as TenantActiveDirectoryUpdateParameters);
        }

        /// <summary>
        /// Returns true if TenantActiveDirectoryUpdateParameters instances are equal
        /// </summary>
        /// <param name="input">Instance of TenantActiveDirectoryUpdateParameters to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TenantActiveDirectoryUpdateParameters input)
        {
            if (input == null)
                return false;
