...
namespace Cohesity.Models
{
    ...
    public partial class SchedulingPolicy :  IEquatable<SchedulingPolicy>
    {
        ...
        public SchedulingPolicy(ContinuousSchedule_ continuousSchedule = default(ContinuousSchedule_), DailyWeeklySchedule_ dailySchedule = default(DailyWeeklySchedule_), MonthlySchedule_ monthlySchedule = default(MonthlySchedule_), PeriodicityEnum? periodicity = default(PeriodicityEnum?))
        {
