...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class VMwareProtectionSource_ :  IEquatable<VMwareProtectionSource_>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VMwareProtectionSource_" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as VMwareProtectionSource_);
        }

        /// <summary>
        /// Returns true if VMwareProtectionSource_ instances are equal
        /// </summary>
        /// <param name="input">Instance of VMwareProtectionSource_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VMwareProtectionSource_ input)
        {
            if (input == null)
                return false;
