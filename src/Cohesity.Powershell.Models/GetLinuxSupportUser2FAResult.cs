...
namespace Cohesity.Model
{
    ...
    public partial class GetLinuxSupportUser2FAResult :  IEquatable<GetLinuxSupportUser2FAResult>
    {
        ...
        /// </summary>
        [DataMember(Name="TOTPQRCodeUrl", EmitDefaultValue=false)]
        public string TOTPQRCodeUrl { get; set; }

        /// <summary>
        /// Gets or Sets TOTPSecretKey
        /// </summary>
        [DataMember(Name="TOTPSecretKey", EmitDefaultValue=false)]
        public string TOTPSecretKey { get; set; }

        /// <summary>
        /// Gets or Sets TwoFAMode
        /// </summary>
        [DataMember(Name="TwoFAMode", EmitDefaultValue=false)]
