...
namespace Cohesity.Model
{
    ...
    public partial class DnsDelegationZone :  IEquatable<DnsDelegationZone>
    {
        ...
        [DataMember(Name="dnsZoneName", EmitDefaultValue=true)]
        ...
        [DataMember(Name="dnsZoneResolvedVips", EmitDefaultValue=true)]
        ...
        [DataMember(Name="dnsZoneVips", EmitDefaultValue=true)]
