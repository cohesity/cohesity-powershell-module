...
namespace Cohesity.Model
{
    ...
    public partial class OldSyslogServer :  IEquatable<OldSyslogServer>
    {
        ...
        public OldSyslogServer(string address = default(string), bool? isClusterAuditingEnabled = default(bool?), bool? isDataProtectionEnabled = default(bool?), bool? isFilerAuditingEnabled = default(bool?), bool? isSshLogEnabled = default(bool?), string name = default(string), int? port = default(int?), int? protocol = default(int?))
        {
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new InvalidDataException("address is a required property for OldSyslogServer and cannot be null");
            }
            else
            {
            ...
            if (port == null)
            {
                throw new InvalidDataException("port is a required property for OldSyslogServer and cannot be null");
            }
            else
            {
                this.Port = port;
            ...
            if (protocol == null)
            {
                throw new InvalidDataException("protocol is a required property for OldSyslogServer and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="isDataProtectionEnabled", EmitDefaultValue=false)]
        ...
        [DataMember(Name="isSshLogEnabled", EmitDefaultValue=false)]
