...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class UniqueGlobalId_ :  IEquatable<UniqueGlobalId_>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniqueGlobalId_" /> class.
        /// </summary>
        ...
        public UniqueGlobalId_(long? clusterId = default(long?), long? clusterIncarnationId = default(long?), long? id = default(long?))
        {
        ...
        {
            return this.Equals(input as UniqueGlobalId_);
        }

        /// <summary>
        /// Returns true if UniqueGlobalId_ instances are equal
        /// </summary>
        /// <param name="input">Instance of UniqueGlobalId_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniqueGlobalId_ input)
        {
            if (input == null)
                return false;
