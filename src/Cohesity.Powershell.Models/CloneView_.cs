...
namespace Cohesity.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class CloneView_ :  IEquatable<CloneView_>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CloneView_" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CloneView_);
        }

        /// <summary>
        /// Returns true if CloneView_ instances are equal
        /// </summary>
        /// <param name="input">Instance of CloneView_ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CloneView_ input)
        {
            if (input == null)
                return false;
