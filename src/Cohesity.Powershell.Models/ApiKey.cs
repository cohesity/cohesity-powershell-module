...
namespace Cohesity.Model
{
    ...
    public partial class ApiKey :  IEquatable<ApiKey>
    {
        ...
        public ApiKey(long? createdTimeMsecs = default(long?), string createdUserSid = default(string), string createdUsername = default(string), long? expiringTimeMsecs = default(long?), string id = default(string), bool? isActive = default(bool?), bool? isExpired = default(bool?), string name = default(string), string ownerUserSid = default(string), string ownerUsername = default(string))
        {
        ...
        [DataMember(Name="createdUserSid", EmitDefaultValue=false)]
        ...
        [DataMember(Name="createdUsername", EmitDefaultValue=false)]
        ...
        [DataMember(Name="ownerUserSid", EmitDefaultValue=false)]
