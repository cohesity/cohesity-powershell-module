...
namespace Cohesity.Powershell.Cmdlets.ProtectionJob
{
    ...
    public class RemoveCohesityProtectionJob : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                deleteSnapshotsCautionMessage = "This action keeps the snapshots " +
                                                "generated by this protection job";
                deleteSnapshots = false;
            }
            else
            {
                deleteSnapshotsCautionMessage = "This action deletes the snapshots " +
                                                "generated by this protection job";
            }
