...
namespace Cohesity.Powershell.Common
{
    internal class RestApiClient
    {
        ...
        public HttpRequestMessage CreateRequest(HttpMethod method, string requestUri)
        {
            ...
            if (SessionId != null)
            {
                request.Headers.Add(CohesityConstants.HttpHeaderSessionId,this.SessionId);
            }
        ...
        public bool IsAuthenticated
        {
            get
            {
                ...
                return (userProfile.AccessToken != null || userProfile.APIKey != null || userProfile.SessionId != null);
            }
        }
